var listaProducto =[]; 
let contador = 0; 
var cambiarNumAP = false;
let bloqueado = false;
var agregarProcedimientoClicked = false;  
      ...
      $('#cie10_5x').keyup(function() {
          ...
          $("#exportarCpmsAudi").click(function(){
            ...
            $("#nomApeConfir").autocomplete({
             ...
             $("#descrEspecCito").autocomplete({
                                                        
                source: "./Controlador/search.php?function=cptCitoEsDescripcion",
                minLength: 3,
                select: function( event, ui ) {
                    event.stopPropagation();
                }
        ...
        $("#marcList").autocomplete({
           ...
           $("#descrEspecCito_informeCito").autocomplete({
            source: "./Controlador/search.php?function=cptCitoEsDescripcion",
            minLength: 3,
            appendTo: "#myModal1", 
            select: function(event, ui) {
                ...
                if(e.which == 9) {
                  e.preventDefault();
                      ...
                      cargarInfoDisaEEssRef(ter);
                            ...
                            $("#descrEspecCito").keypress(function(e) {
                                if(e.which == 13) {
                                  e.preventDefault();
                                  var cunx = $(this).val();
                                  buscarCodDxMorf(cunx);
                                    
                                }
                              });
                    
                
                              $("#descrEspecCito").keydown(function(e) {
                                if(e.which == 9) {
                                  e.preventDefault();
                                    var cunx = $(this).val();
                                    buscarCodDxMorf(cunx);
                            ...
                            $("#descrEspecCito_informeCito").keypress(function(e) {
                                if(e.which == 13) {
                                  e.preventDefault();
                                  var cunx = $(this).val();
                                  buscarCodDxMorf_informe_cito(cunx);
                                    
                                }
                              });
                    
                
                              $("#descrEspecCito_informeCito").keydown(function(e) {
                                if(e.which == 9) {
                                  e.preventDefault();
                                    var cunx = $(this).val();
                                    buscarCodDxMorf_informe_cito(cunx);
...
//
        ...
        /*$('#dx5').keyup(function() {
          ...
          $('#enviar').click(function(){
            ...
            $("#existeNeo").change(function () {
                var item = $(this).val(); // Obtener el valor del select
        
                console.log("Valor seleccionado:", item); // Para depuración en consola
        
                if (item == '1') { // Compara con "1" (string)
                    $("#NuevoTablesFrm").fadeIn(); // Muestra con animación
                } else {
                    $("#NuevoTablesFrm").fadeOut(); // Oculta con animación
                }
            });
            $("#existeNeo_InformeCito").change(function () {
                var item = $(this).val(); // Obtener el valor del select
        
                console.log("Valor seleccionado:", item); // Para depuración en consola
        
                if (item == '1') { // Compara con "1" (string)
                    $("#NuevoTablesFrm_InformeCito").fadeIn(); // Muestra con animación
                } else {
                    $("#NuevoTablesFrm_InformeCito").fadeOut(); // Oculta con animación
                }
            });
          ...
          $("#cantMedAuto").keyup(function(){
            ...
            $("#ctinmuno").keypress(function(e) {
                ...
                $("#idBtnValidarSisHnal").removeClass("hidden");
                $("#cod_tarifado").removeClass("hidden");
                $("#tbl_procedimientos").addClass("hidden");
                $("#IdGenerarFua").removeClass("hidden");
                if(e.which == 13) { 
                    e.preventDefault(); 
                    limpiarCampos();
                    $("#nroSerie").val('');
                     ...
                     if (IdCuentaAtencion !== "") {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                console.log('gaa',respuesta);
                                var datos = respuesta.datos;
                                var idTipoDoc = datos.IdDocIdentidad;
                                ...
                                if (datos) {
                                    ...
                                    $("#tipoDocPato").val(datos.IdDocIdentidad);
                                    $("#nroDocPato").val(datos.NroDocumento);
                                    $("#pacientePato").val(datos.ApellidoPaterno+' '+datos.ApellidoMaterno+' '+datos.PrimerNombre+' '+datos.SegundoNombre);
                                    $("#edadPato").val(datos.Edad);
                                    if(datos.IdTipoSexo==1){
                                        $("#sexoPat").val("M");
                                    }else{
                                        $("#sexoPat").val("F");
                                    }
                                    if(datos.idFuenteFinanciamiento== 3){
                                        $("#financiaPTO").val(2);
                                        $("#selecConvenio").val(1);
                                    ...
                                    // $("#financiaPTO").val(datos.idFuenteFinanciamiento);
                                    if(datos.IdTipoServicio ==2){
                                        datos.IdTipoServicio=1
                                        // $("#IdGenerarFua").addClass("hidden");

                                    }else if(datos.IdTipoServicio == 3){
                                        datos.IdTipoServicio=2
                                        // $("#IdGenerarFua").addClass("hidden");
                                    }else if (datos.IdTipoServicio == 1)
                                    {
                                        datos.IdTipoServicio=3

                                        // $("#IdGenerarFua").removeClass("hidden");
                                    }else if(datos.IdTipoServicio = 5){
                                        datos.IdTipoServicio=4
                                        // $("#IdGenerarFua").removeClass("hidden");
                                    }
                                    cargarTipoServicioPat(datos.IdTipoServicio);
                                    buscarServicio(datos.codCompatible, function(IdServicio) {
                                        if (IdServicio !== null) {
                                            // var idServicioNum = parseInt(IdServicio, 10);
                                            console.log('IdServicio:', IdServicio);
                                            cargarTipoServicioPatSer(datos.IdTipoServicio,IdServicio);
                                        } else {
                                            console.log('No se obtuvo un IdServicio.');
                                        }
                                    });
                                   
                                   
                                    $("#celularPacientePatologia").val(datos.Telefono);
                                    $("#historiaPat").val(datos.NroHistoriaClinica); //OBSERVADO DESAPARECE
                                    $("#mediSolicitante").val(datos.MediOrdena);
                                    $("#especialPat").val(datos.EspecialidadMediProviene);
                                    var fechaActual=obtenerFechaHoy();
                                    console.log('fechaa',fechaActual);
                                    $("#fechaPat").val(fechaActual);
                                    $("#factPat").val("NN");
                                    $("#salacamaPat").val("NN");
                                    $("#iprId").val("HOSPITAL ARZOBISPO LOAYZA ");
                                    // webServiceSisPato(idTipoDoc,nroDocumento);
                                    $("#ctaPadreVinculada").val(datos.CuentaPadre);
                                    $("#servPadreVincu").val(datos.NombreServicioPadre);
                                    ...
                                    alert("No se encontraron datos para el número de cuenta proporcionado.");
                                }
                            },
            ...
            $("#nroOrdenReceta").keypress(function(e) {

                //cambiarNumAP =false;
                $("#idBtnValidarSisHnal").removeClass("hidden");
                $("#cod_tarifado").removeClass("hidden");
                $("#tbl_procedimientos").removeClass("hidden");
                $("#IdGenerarFua").removeClass("hidden");
                if(e.which == 13) { 
                    e.preventDefault(); 
                    limpiarCampos();
                    ...
                    $("#nro_movimiento").val('');
                    $("#IdOrden").val('');
                    var nroOrdenReceta = $(this).val(); 
                    console.log(nroOrdenReceta);
                     if (nroOrdenReceta !== "") {
                          var  financiaPTO =0;
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                if(respuesta.mensaje=="No se encontro Datos para esa Receta"){
                                    alert('No se encontraron datos para esta Orden');
                                    $("#tbl_procedimientos").addClass('hidden');
                                ...
                                if (datos) {
                                    ...
                                    if(datos.FuenteFinanciamiento== "SIS"){
                                        $("#financiaPTO").val(2);
                                    }else{
                                        $("#financiaPTO").val(1);
                                    }
                                    if(datos.IdTipoServicio ==1){
                                        datos.IdTipoServicio= 3
                                    }else if(datos.IdTipoServicio == 2){
                                        datos.IdTipoServicio  =1
                                    }else{
                                        datos.IdTipoServicio = 2
                                    }
                                    ...
                                    $("#ctinmuno").val(datos.idCuentaAtencion);
                                   ...
                                   var fecha= obtenerFechaHoy();
                                    $("#fechaPat").val(fecha);
                                    $("#factPat").val('NN');
                                    $("#ctaPadreVinculada").val('');
                                    $("#servPadreVincu").val('');
                                    $("#IdOrden").val(datos.IdOrden);
                                    
                                    
                                    var idProducto = datos.IdProducto;
                                    console.log('idprouducto',idProducto);

                                    obtenerProcexProducto(idProducto, function(error, data) {
                                        if (error) {
                                            console.error('Se produjo un error:', error);
                                        } else {
                                            if(data == null){
                                                alert('NO SE ENCONTRARON DATOS PARA ESE PROCEDIMIENTO');
                                            }
                                            console.log('Datos recibidos:', data);
                                            if (data) {
                                                console.log('ID procedimiento:', data.idProcedimiento);
                                                console.log('ID TiEStudio:', data.idTipoEstudio);
                                                console.log('ID SubProce:', data.idSubProced);
                                                //  let data1 = await buscarCorrelPatfParticular(data.idTipoEstudio, data.idProcedimiento, data.idSubProced);
                                               // buscarCorrelPatfParticular(data.idTipoEstudio,data.idProcedimiento);
                                                
                                                if( data.idTipoEstudio == 3){
                                                    data.idTipoEstudio=2
                                                }
                                                if( data.idTipoEstudio  == 2){

                                                    cargartipoEstPat(data.idTipoEstudio);
                                                    if(data.idProcedimiento != 19){
                                                        cargarprocePat( data.idTipoEstudio,data.idProcedimiento);
                                                     buscarCorrelPatf(data.idTipoEstudio,data.idProcedimiento);
                                                    }else{
                                                        cargarprocePat( 2,19);
                                                        buscarProcedFacturado(19);
                                                        buscarCorrelPatf(2,19);
                                                      
                                                        // cargarSubprocePat(2,0);
                                                        // buscarSubProcedFacturado(data.idSubProced);
                                                        $("#subProcePat").val(data.idSubProced);
                                                        $("#lblsubpro").removeClass("hidden");
                                                        $("#selesubproc").removeClass("hidden");
                                                        $("#cantidadProc").val(datos.Cantidad);
                                                ...
                                                // $("#tipoEstPat").val(data.idTi);
                                                // $("#procePat").val(data.idtpo);
                                                // cargartipoEstPat(data.idTi);
                                              
                                                // buscarProcedFacturado(data.idtpo);
                       ...
                       $.ajax({
                            ...
                            success: function(res) {
                                ...
                                var respuesta = JSON.parse(res);
                                console.log('datos por orden',respuesta);
                                if(respuesta.mensaje=="No se encontro Datos para esa Receta"){
                                    alert('No se encontraron datos para esta Boleta');
                                    $("#tbl_procedimientos").addClass('hidden');
                                ...
                                if (datos) {
                                    ...
                                    $("#celularPacientePatologia").val(datos.Telefono);
                                    $("#historiaPat").val(datos.NroHistoriaClinica); 
                                   var fecha= obtenerFechaHoy();
                                    $("#fechaPat").val(fecha);
                                    $("#factPat").val('NN');
                                    $("#ctaPadreVinculada").val('');
            ...
            function limpiarCampos() {
                ...
                $("#idReceta").val('');
                $("#salacamaPat").val('');
                $("#celularPacientePatologia").val('');
                $("#selecConvenio").val('');
                // $("#ipressConvenio").addClass("hidden");
                // $("#subProcePat").addClass("hidden");
            ...
            function ocultarBotones() {
                ...
                // if(serie = "" && nroDocumento =""){
                //     $("#validarSisHnalInforme").addClass("hidden");
                // }
            ...
            $("#nroDocumento").keypress(function(e) {
                ...
                if(e.which == 13) { 
                    e.preventDefault(); 
                      limpiarCampos();
                    //   $("#ctinmuno").val('');
                    //$("#cod_tarifado").remove("hidden");
                    $("#idBtnValidarSisHnal").addClass("hidden");
                    $("#IdGenerarFua").addClass("hidden");
                    $("#tbl_procedimientos").removeClass('hidden');
                    $("#nroOrdenPat").val('');
                    $("#cod_tarifado").addClass("hidden");
                    $("#validarSisHnalInforme").addClass("hidden");
                  
                    var idtipoEstudio =0;
                    var nroDocumento = $("#nroDocumento").val();
                    var nroSerie = $("#nroSerie").val();
                    console.log(nroDocumento,nroSerie);
                    console.log('nroSerie',nroSerie);
                    console.log('nroDocumento',nroDocumento);

                    
                     if (nroDocumento !== "") {
                        var nroDocumentoTexto = String(nroDocumento);
                        var nroSerieTexto = String(nroSerie);
                        ...
                        $.ajax({
                            ...
                            data: { 
                                opcionResys: 4,
                                nroSerie :nroSerieTexto,
                                nroDocumento:nroDocumentoTexto
                            ...
                            success: function(res) {
                                ...
                                var respuesta = JSON.parse(res);
                                console.log('datos boleta',respuesta);
                                if(respuesta.mensaje=="No se encontro Datos para esa Receta"){
                                    alert('No se encontraron datos para esta Boleta');
                                    $("#tbl_procedimientos").addClass('hidden');
                        ...
                        alert("Por favor ingresa una Receta.");
                    }
        ...
        $("#cargarcie10").click(function(){
         ...
         /* $("#servicio").autocomplete({
           ...
           $("#productoX").autocomplete({
            ...
            $("#clasificacionGen").change(function() {
                var clasGen = $("#clasificacionGen").val();	
               if(clasGen== 5){
               
                    $("#EspecclasificacionGen").prop("disabled", true);
                    $("#celulasEscamosas").prop("disabled", true);
                    $("#especelulasEscamosas").prop("disabled", true); 
                    $("#celGlandu").prop("disabled", true);
                    $("#espeCelGlandu").prop("disabled", true);
                    $("#otrNeoMalig").prop("disabled", true);
            
               }
               if(clasGen == 6){
                $("#EspecclasificacionGen").prop("disabled", true);
                $("#celulasEscamosas").prop("disabled", false);
                $("#especelulasEscamosas").prop("disabled", false); 
                $("#celGlandu").prop("disabled", false);
                $("#espeCelGlandu").prop("disabled", false);
                $("#otrNeoMalig").prop("disabled", false);
               }
               if(clasGen == 7){
                $("#EspecclasificacionGen").prop("disabled", false);
                $("#celulasEscamosas").prop("disabled", false);
                $("#especelulasEscamosas").prop("disabled", false); 
                $("#celGlandu").prop("disabled", false);
                $("#espeCelGlandu").prop("disabled", false);
            ...
            //     // Redirige directamente a la URL del archivo para que el navegador inicie la descarga
            //     window.location.href = 'ruta/del/archivo/5710638.xlsx';
            // });
            ...
            $("#tipoEstPat").change(function() {
                ...
                var dsIt = $("#procePat").val();
                     ...
                     if(idDis==1){ //EstudioPatologia
                         $("#paso2").removeClass("hidden");
                         $("#paso3").removeClass("hidden");
                         $("#paso3").addClass("hidden");
                        // $("#AgregarProcedimiento").addClass("hidden");//Agregado
                         $("#no4").text("4");
                ...
                var tipoEstPat = $("#tipoEstPat").val();
                      ...
                      if(idDis==13 && tipoEstPat==2){
                         ...
                         $("#paso2").removeClass("hidden");
                          ...
                          $("#lblsubpro").addClass("hidden");
                          $("#selesubproc").addClass("hidden");
                            ...
                            $("#lblsubpro").removeClass("hidden");
                            $("#selesubproc").removeClass("hidden");
                            $("#AgregarProcedimiento").removeClass("hidden");//Agregado
            ...
            $("#subProcePat").change(function() {
                var idDis = $("#subProcePat").val();	
                buscarSubProcedFacturado(idDis);
            });
            ...
            $(document).on('change', '#contenedorFilas #tipoEstPatProced2', function() {
                console.log('changee');
              
                var idDis = $(this).val(); // Obtenemos el valor seleccionado
                $("#procePatProced2").html('');
                cargarprocePatProced2(idDis,0);
                //buscarCorrelPatf(idDis);
                // cargarListCategoria(idDis);
            });
            ...
            $("#procePat").change(function() {
                var idDis = $("#procePat").val();
                var idsubtipo = $('#procePat option:selected').data('idsubtipo');
                if(idDis == 19){
                    $("#codTarifado").html('');
                }
              
                cargarSubprocePat(idsubtipo,0);              
            });
            
             //Agregado
             $(document).on('change', '#contenedorFilas #procePatProced2', function() {
                //console.log('changee prced');
            
                var idDis = $("#procePatProced2").val();
                var idsubtipo = $('#procePatProced2 option:selected').data('idsubtipo');
                if(idDis == 19){
                    $("#codTarifado").html('');
                    $("#lblsubproProced2").removeClass("hidden");
                    $("#selesubprocProced2").removeClass("hidden");
                }else{
                    $("#lblsubproProced2").addClass("hidden");
                 $("#selesubprocProced2").addClass("hidden");

                }
                console.log('idsubtipo',idsubtipo)
                
                
                cargarSubprocePatProced2(idsubtipo,0);   
            });
...
// FIN LOAD WINDOWS SCARTE
            ...
            // async function obtenerProcexProducto(IdProducto) {
            //     var idProducto =IdProducto;
            //     try {
            //         let response = await $.ajax({
            //             url: "./Controlador/search.php?function=obtenerProcexProducto",
            //             dataType: 'json',
            ...
            //             },
            //         });
            //         return response; // Este será el valor retornado cuando se complete el AJAX
            //     } catch (error) {
            ...
            // }
            function obtenerProcexProducto(IdProducto, callback) {
                $.ajax({
                    url: "./Controlador/search.php?function=obtenerProcexProducto",
                    dataType: 'json',
                    method: 'GET',
                ...
                .done(function(response) {
                    callback(null, response); // Llama al callback con el resultado
                })
                .fail(function(error) {
                    console.error('Error en la petición:', error);
            ...
            function impresionMasiva (){
                ...
                if(desde !="" && hasta !=""){
                    ...
                    //   window.open('http://192.168.36.121:8084/hnal/imprimirMasivo.php?user='+user+'&desde='+desde+'&hasta='+hasta+'&id='+tipoEv, '_blank');
                }else{
                ...
                function buscarCodDxMorf(cuenta)
                {
            
                 
                    $.ajax({
                        url:'./Controlador/search.php?function=buscarCodDxMorf',
                        type:'GET',
                        dataType:'json',
                        data:{ id:cuenta}
                            ...
                            $("#cptCitoEs").val(datos[0]);
                        
                    });
                        
                       
                } 
                function buscarCodDxMorf_informe_cito(cuenta)
                {
            
                 
                    $.ajax({
                        url:'./Controlador/search.php?function=buscarCodDxMorf_informe_cito',
                        type:'GET',
                        dataType:'json',
                        data:{ id:cuenta}
                            ...
                            $("#cptCitoEs_informeCito").val(datos[0]);
                ...
                function editarRegistroPatologia(id)  {
                    ...
                    if(id==""){
                       ...
                       $.ajax({
                           ...
                           console.log(datos);
                           $("#NumeroProced").val(datos['NumeroProced']);
                           //$("#existeNeo_InformeCito").val(datos['existeNeo']);
                          
                                if(datos['exiteNeo_Informe'] == 1){
   
                                   $("#existeNeo_InformeCito").val(1);
                                   
                                   // $("#existeNeo").prop("disabled", true);
                                   $("#NuevoTablesFrm_InformeCito").show();
                                   CargarCptCitologia(id);
                               }else{
                                   $("#existeNeo_InformeCito").val(2);
                                   $("#NuevoTablesFrm_InformeCito").hide();
                                   // $("#existeNeo").prop("disabled", true);      
                                     }
                           ...
                           if(datos)
                               //Agregado
                           if(datos['NumeroProced']==2){
                              
                               mostrarSegundProc();
                               if(datos[84] == 19){
                                   $("#lblsubproProced2").removeClass("hidden");
                                   $("#selesubprocProced2").removeClass("hidden");
                                   $("#subProcePatProced2").val(datos[85]);

                               }
                              
                               cargartipoEstPatProced2(datos[83]);
                               cargarprocePatProced2(datos[83],datos[84]);

                            
                               //cargarSubprocePatProced2(datos[84],0);
                             
                               $("#cantidadProcProced2").val(datos[86]);
                               
                               //Agregado
                               if(datos[83]=="1" || datos[83] =="2"){
                                   $("#tipoEstPatProced2").css("pointer-events","none");$("#tipoEstPatProced2").css("background","#c7c7c7");
                                   $("#procePatProced2").css("pointer-events","none");$("#procePatProced2").css("background","#c7c7c7");
                               }
                           }
                           ...
                           //cambiosGerardo
                           if( datos[5] != "1"){
                               $("#validarSisHnalInforme").removeClass("hidden");
                           }
                           if(datos[74]!="" && datos[75] !=""){
                               $("#IdGenerarFua").addClass("hidden");
                               $("#idBtnValidarSisHnal").addClass("hidden");
                               $("#GuardarPacienteModificado").addClass("hidden");
                               $("#validarSisHnalInforme").addClass("hidden");

                               //$("#nroSerie").css("pointer-events","none");$("#nroSerie").css("background","#c7c7c7");
                               //$("#nroDocumento").css("pointer-events","none");$("#nroDocumento").css("background","#c7c7c7");
                               //$("#ctinmuno").css("pointer-events","none");$("#ctinmuno").css("background","#c7c7c7");
                           ...
                           $("#nroOrdenReceta").val(datos[87]);
                           $("#historiaPat").val(datos[9]);
                           $("#servicioPat").val(datos[10]);
                           $("#salacamaPat").val(datos[11]);
                           $("#celularPacientePatologia").val(datos[12]);
                           $("#nroSerie").val(datos[74]);
                           $("#nroMovimiento").val(datos[80]);
                           $("#nroOrdenMovimiento").val(datos[81]);
                           $("#cantidadProc").val(datos[82]);
                           
                           $("#nroDocumento").val(datos[75]);
                           $("#ctaPadreVinculada").val(datos[76]);
                           $("#servPadreVincu").val(datos[77]);
                           $("#IdOrden").val(datos[78]);
                           //cambiosGerardo
                           //$("#nroOrdenPat").val(datos[13]);
                           $("#factPat").val(datos[15]);
                           cargartipoEstPat(datos[16]);   
                           cargarprocePat(datos[16],datos[17]);
                           $("#subProcePat").val(datos[79]);
                           ...
                           if(datos[17]==13 && datos[16]==2){
                                  ...
                                  // CargarTacosPat(1);
                                   ...
                                   var link2="http://192.168.36.121:8084/hnal/pdfAnatomoPatologicoVistaPrevia2.php?id="+ip;
                           ...
                           $("#EspecCelulasEndoCervicales").val(datos[88]);
                ...
                //Gerardo
                function buscarServicio(codCompatible,callback){
                    $.ajax({
                        url:'./Controlador/search.php?function=buscarServicio',
                        method: 'GET', 
                        data: { 
                           
                            codCompatible:codCompatible}, 
                        success: function(res) {
                            var IdServicio = JSON.parse(res);
                            if (IdServicio !== null && !isNaN(IdServicio)) {
                                // Convierte el valor a un número entero
                                var idServicioNum = parseInt(IdServicio, 10);
                
                                // Llama al callback con el número convertido
                                callback(idServicioNum);
                            } else {
                                console.log('No se obtuvo un IdServicio o el valor no es numérico.');
                                callback(null); // Llama al callback con null para indicar un error
                            }
                        },
                        error: function(xhr, status, error) {
                            alert("Ocurrió un error al obtener los datos: " + error);
            ...
            function modInmuno2(){
                ...
                cambiarNumAP=true;
                $("#tipoEstPat").css("pointer-events", "auto").css("background", "");
                $("#procePat").css("pointer-events", "auto").css("background", "");
            ...
            async function buscarProcedVinculado(procePAt) {

                try {
                    let response = await $.ajax({
                        url: "./Controlador/search.php?function=buscarProcedVinculado",
                        dataType: 'json',
                        method: 'POST', // o POST según sea necesario
                        data: {
                            procePAt: procePAt
                        },
                    });
            ...
            // async function buscarMedicoVinculado() {
            //     // var idauditorAsignado = $('#idAuditorAsignado').val();
            //     var idauditorAsignado = $('#idAuditorAsignado option:selected').text();

                  
            //     // Separar la cadena en dos partes
            //     var nombresApellidos = idauditorAsignado.split(',');
            //     var nombres = nombresApellidos[0].trim(); // "ALVAREZ BEDOYA"
            //     var apellidos = nombresApellidos[1].trim(); // "PIERINO HUMBERTO"

            //     // Separar nombres y apellidos individuales
            //     var partesNombres = nombres.split(' '); // ["ALVAREZ", "BEDOYA"]
            //     var partesApellidos = apellidos.split(' '); // ["PIERINO", "HUMBERTO"]

            //     // Asignar cada parte a variables
            //     var primerNombre = partesNombres[0]; // "ALVAREZ"
            //     var segundoNombre = partesNombres.length > 1 ? partesNombres[1] : ''; // "BEDOYA"
            //     var primerApellido = partesApellidos[0]; // "PIERINO"
            //     var segundoApellido = partesApellidos.length > 1 ? partesApellidos[1] : ''; 
            
            //         console.log('id nombre auditor enviado',idauditorAsignado); 
            //         console.log('aaaaa',primerNombre, segundoNombre); 
                   
            //         try {
            //             let response = await $.ajax({
            //                 url: "./Controlador/search.php?function=buscarMedicoVinculado",
            //                 dataType: 'json',
            //                 method: 'POST',
            //                 data: {
            ...
            //             // Manejar la respuesta dependiendo de su contenido
            //             if (response.error) {
            //                 console.error('Error en el servidor:', response.error);
            //             } else if (response.found === false) {
            //                 console.log('No se encontraron resultados para:', idauditorAsignado);
            //             } else {
            //                 console.log('Resultado encontrado:', response);
                           

            //                 return response; // Retornar el resultado si se encontró
            //             }
                        
            //         } catch (error) {
            //             console.error('Error en la petición:', error);
            //             throw error; // Manejo de error en caso de fallo en la solicitud
            //         }
            ...
            // }
             async function buscarDatosMedicoVinculado(IdEmpleado) {
                try {
                    let response = await $.ajax({
                        url: "./Controlador/ejecutarResys.php?function=buscarDatosMedicoVinculado",
                        dataType: 'json',
                        method: 'GET', // o POST según sea necesario
                        data: {
                            opcionResys:5,
            ...
            async function  generarMovimiento(proceEncontrado,idOrden){
           
                var codEmpleado = 0;
                var IdservicioEgreso = 0;
                var rne=0;
                var dni=0;
                var datos =0;
                var idmedico=0;
                var idMedicoEncontradoGale =0;
                var IdMedicoEgreso = 0;
                var IdUserGale =0;
                var cantidadProce=$('#cantidadProc').val();
                var IdMedico =0;
                var idtipoFinanciamiento = $('#financiaPTO').val();
                var IdPersonaTomaLab = $('#idAuditorAsignado option:selected').data('codcompatible');
                var IdEmpleado = $('#idAuditorAsignado option:selected').data('codcompatible');
                var mediSolicitante = $('#mediSolicitante').val();
                var IdservicioPat = $('#servicioPat').val();
                var formato = /^\d+\s\|\s[A-ZÁÉÍÓÚÑ\s]+$/;
                var Fecha = $('#fechaPat').val();
                var procePAto = proceEncontrado;
                var nroOrdenReceta = $('#nroOrdenReceta').val();
                var segundoProced = 0 ;
                console.log('vvv2',procePAto);
                if(formato.test(mediSolicitante)){
                    var nombreCompleto = mediSolicitante.split('|');
                    var nombre = nombreCompleto[1] ? nombreCompleto[1].trim() : '';
                    mediSolicitante = nombre;
                }
                //Agregado
                var  procePatProced2 =  $('#procePatProced2').val();
                if(procePatProced2 ==19){
                    procePatProced2 =  $('#subProcePatProced2').val();
                }
                
                let resp = await buscarProcedVinculado(procePatProced2);
                if(resp != null){
                    segundoProced = resp;
                }

               
                console.log('segundo  procedi,iemto encontrado',segundoProced)
                // alert(mediSolicitante);
                var Idcuenta = $('#ctinmuno').val();
                // var auditoAsignado = $('#idAuditorAsignado').val();
                var IdUsuario = $('#iduser').val();
                console.log('usuario logeado',IdUsuario);
                console.log('id medio asignado',IdEmpleado);


                // let resp = await buscarMedicoVinculado();
                //       if(resp){
                //                 rne = resp.rne;
                //                  dni = resp.dni; 
                //         }
              
                //   console.log('rne medico encontrado',rne,dni)

               let rneMedicoPatologo  = await buscarDatosMedicoVinculado(IdEmpleado);
                console.log('respuesta IdMedico PAtolog',rneMedicoPatologo)
                    // datosMedico =JSON.parse(rneMedicoPatologo);
                ...
                console.log(' Id medico  encontrado en gale', IdMedico)
              
                // buscarServicioSIGH(IdservicioPat,function(codServicioSIGH){
                    let codServicioSIGH = await buscarServicioSIGH(IdservicioPat);
                    if(!codServicioSIGH){
                        console.log("codigo servicio Vacio",codServicioSIGH)
                    }
                        console.log("codigoo servicio Encontrado ",codServicioSIGH)
                    
                        IdservicioEgreso =parseInt(codServicioSIGH,10);

                        // buscarUsuarioVinculado(user,function(codCompatibleEncontrado) {
                            let codCompatibleEncontrado = await buscarUsuarioVinculado(IdUsuario);
                           
                                console.log("codigoo Usaurio Encontrado",codCompatibleEncontrado)
                             
                                IdUserGale = codCompatibleEncontrado;
        
                                    if(procePAto){
                                        console.log('vvvvv3',procePAto);
                                        try {
                                            let response = await $.ajax({
                                                url: "./Controlador/ejecutarResys.php?",
                                                dataType: 'json',
                                                ...
                                                data: {
                                                    ...
                                                    MediOrdena: mediSolicitante,
                                                    idProductoCPT:procePAto,
                                                    idProductoCPT2:segundoProced, //Agregado
                                                    IdUsuario :IdUserGale,
                                                    IdMedico: IdMedico,
                                        ...
                                        $.NotificationService.showErrorNotification({
                                            title:"Mensaje",
                                            message:"Error Con el valor del Procedimiento"
                                        });
            
                                    }
    
            }
            async function  actualizaMovimiento(proceEncontrado,idOrden){
                ...
                //Agregado
                var  procePatProced2 =  $('#procePatProced2').val();
                var CantidadProced2 =  $('#cantidadProcProced2').val();
                
                if(procePatProced2 ==19){
                    procePatProced2 =  $('#subProcePatProced2').val();
                }
                if(CantidadProced2 == undefined){
                    CantidadProced2 = 0
                }
                ...
                var Idcuenta = $('#ctinmuno').val();
                var IdMovimiento  = $('#nroMovimiento').val();
            ...
            async function registrarPacientePatologia() {
                if (bloqueado) return;
            
                 bloqueado = true;
            
                var btn = $("#btnRegistrarPaciente");
                btn.prop("disabled", true);
            
                var tipoEstudio =  $("#tipoEstPat").val();
                var tipoEstudioProced2 =  $("#tipoEstPatProced2").val();
                var procePAt = $("#procePat").val();
                var procePAt2 = $("#procePatProced2").val();

                // if(tipoEstudio == tipoEstudioProced2 &&  procePAt == procePAt2){
                //     alert('No puede cargar el mismo procedimiento a una orden');
                //     return;
                // }
                ...
                if (procePAt == 19) {
                    procePAt = $("#subProcePat").val();
                }
            
                var tipoEstPatProced2 = $('#tipoEstPatProced2').val();
                console.log('tipoEstPatProced2', tipoEstPatProced2);
            
                var codTarifado = $('#codTarifado').val();
                var ctinmuno = $('#ctinmuno').val();
                var selectElement = document.getElementById('procePat');
                ...
                if (codTarifado == "NO TARIFADO") {
                    if (confirm('Desea Cargar el Procedimiento: ' + selectedText + ' a la cuenta ' + ctinmuno)) {
                        setTimeout(function () {
                            registroPacientePatologia();
                    ...
                    if (agregarProcedimientoClicked) { 
                        ...
                        var idRegPatot=  $('#idRegPatot').val();
                        if(idRegPatot != ""){
                            let resp = await buscarProcedVinculado(procePAt);
                            let response = await actualizaMovimiento(resp, idOrden);
                            if (response.resultado) {
                                $.NotificationService.showInfoNotification({
                                    title: "Mensaje",
                                    message: "Se actualizó Movimiento " + response.datos.IdMovimiento + " correctamente"
                                });
                                registroPacientePatologia();
                            } else {
                                $.NotificationService.showErrorNotification({
         ...
         async function registroPacientePatologia()
            {
                var NumeroProced =0;
              
          
                if (modificarNumAP()) {
                    const nuevoNumAPNuevo = $("#nroOrdenPat").val();
               
                    
                    if (nuevoNumAPNuevo.includes('-')) {
                      
                        const cortPatNuevo = nuevoNumAPNuevo.split('-')[1];
                        
                     
                        $('#corPat').val(cortPatNuevo);
                        $('#nroOrdenPat').val(nuevoNumAPNuevo);
                    } else {
                        console.error('El número de orden no tiene el formato esperado');
                    }
                }
                    var ctinmuno =  $('#ctinmuno').val();
                    var nroOrdenVincuBoleta =  $('#IdOrden').val();
                    var nroSerie=  $('#nroSerie').val();
                    // Agregado SEGUNDO PROCEDIMIENTO
                    var  tipoEstPatProced2 =  $('#tipoEstPatProced2').val();
                    console.log('tipoEstPatProced2',tipoEstPatProced2);
                    var  procePatProced2 =  $('#procePatProced2').val();
                    var  subProcePatProced2 =  $('#subProcePatProced2').val();
                    var  cantidadProcProced2 =  $('#cantidadProcProced2').val();

                    if(agregarProcedimientoClicked){
                        NumeroProced= 2;
                        $("#NumeroProced").val(NumeroProced);
    
                    }
                  
                     NumeroProced =  $('#NumeroProced').val();
                  
                    
                    
                    // var IdOrden=  $('#IdOrden').val();
                    var nroDocumento=  $('#nroDocumento').val();
                    var ctaPadreVinculada=  $('#ctaPadreVinculada').val();
                    var servPadreVincu=  $('#servPadreVincu').val();
                    var tipoDocPato=  $('#tipoDocPato').val();
                    var nroDocPato=  $('#nroDocPato').val();
                    var iduser=  $('#iduser').val();
                    var idRegPatot=  $('#idRegPatot').val();
                    var pacientePato=  $('#pacientePato').val();
                    var edadPato=  $('#edadPato').val();
                    var sexoPat=  $('#sexoPat').val();
                    var financiaPTO=  $('#financiaPTO').val();
                    var iprId=  $('#iprId').val();
                    var juriPr=  $('#juriPr').val();
                    var salacamaPat=  $('#salacamaPat').val();
                    var historiaPat=  $('#historiaPat').val();
                    var tipoServicoPatl=  $('#tipoServicoPatl').val();
                    var servicioPat=  $('#servicioPat').val();
                    var celularPacientePatologia=  $('#celularPacientePatologia').val();
                    var selecConvenio=  $('#selecConvenio').val();
                    var idRegSec2=  $('#idRegSec2').val();
                    var iduser2=  $('#iduser2').val();
                    var factPat=  $('#factPat').val();
                    var tipoEstPat=  $('#tipoEstPat').val();
                    var corPat=  $('#corPat').val();
                    var procePat=  $('#procePat').val();
                    var subProcePat=  $('#subProcePat').val();
                    var codTarifado=  $('#codTarifado').val();
                    var mediSolicitante=  $('#mediSolicitante').val();
                    var especialPat=  $('#especialPat').val();
                    var fechaPat=  $('#fechaPat').val();
                    var tesjidoPat=  $('#tesjidoPat').val();
                    var idtipoEstPat=  $('#idtipoEstPat').val();
                    var nroOrdenPat=  $('#nroOrdenPat').val();
                    var idAuditorAsignado=  $('#idAuditorAsignado').val();
                    var cuentaAtencion =  $('#ctinmuno').val();
                    var nroOrdenReceta =  $('#nroOrdenReceta').val();
                    var cantidadProce =  $('#cantidadProc').val();
                    var ipressConvenio = $("#ipressConvenio").val();
                    console.log('ipress',ipressConvenio);
    
                    var muestras = [];
                    $('#tbl_tesjidoPat tbody tr').each(function() {
                        var muestra = $(this).find('td:first').text(); 
                        muestras.push(muestra); 
                        
                    });
                    console.log('muestras de tabla',muestras);
                   
    
                    var info = {
                        ctinmuno: ctinmuno,
                        nroSerie: nroSerie,
                        nroOrdenVincuBoleta: nroOrdenVincuBoleta,
                        nroDocumento: nroDocumento,
                        ctaPadreVinculada: ctaPadreVinculada,
                        servPadreVincu: servPadreVincu,
                        tipoDocPato: tipoDocPato,
                        nroDocPato: nroDocPato,
                        iduser: iduser,
                        idRegPatot: idRegPatot,
                        pacientePato: pacientePato,
                        edadPato: edadPato,
                        sexoPat: sexoPat,
                        financiaPTO: financiaPTO,
                        iprId: iprId,
                        juriPr: juriPr,
                        salacamaPat: salacamaPat,
                        historiaPat: historiaPat,
                        tipoServicoPatl: tipoServicoPatl,
                        servicioPat: servicioPat,
                        celularPacientePatologia: celularPacientePatologia,
                        selecConvenio: selecConvenio,
                        idRegSec2: idRegSec2,
                        iduser2: iduser2,
                        factPat: factPat,
                        ...
                        corPat: corPat,
                        procePat: procePat,
                        subProcePat: subProcePat,
                        codTarifado: codTarifado,
                        mediSolicitante: mediSolicitante,
                        especialPat: especialPat,
                        fechaPat: fechaPat,
                        tesjidoPat: tesjidoPat,
                        idtipoEstPat: idtipoEstPat,
                        nroOrdenPat: nroOrdenPat,
                        idAuditorAsignado: idAuditorAsignado,
                        muestras:muestras,
                        cuentaAtencion:cuentaAtencion,
                        nroOrdenReceta:nroOrdenReceta,
                        cantidadProce:cantidadProce,
                        ipressConvenio:ipressConvenio,
                        tipoEstPatProced2 : tipoEstPatProced2,
                        procePatProced2 :procePatProced2 ,
                        subProcePatProced2 :subProcePatProced2,
                        cantidadProcProced2:cantidadProcProced2,
                        NumeroProced:NumeroProced
               ...
               var numMovi = 0;
                var rneMedico;
                var dniMedico;
                var nroMovimiento = $('#nroMovimiento');
                var idOrden = $('#IdOrden').val();
                var iduser = $("#iduser").val(); 
                var sexoPat = $("#sexoPat").val(); 
                var financiaPTO = $("#financiaPTO").val();
                ...
                var selecConvenio = $("#selecConvenio").val();
                var ipressConvenio = $("#ipressConvenio").val();
                var auditor =  $("#idAuditorAsignado").val();
                var procePAt = $("#procePat").val();
                if(procePAt == 19){
                     procePAt = $("#subProcePat").val();
                }
                ...
                if(nroMovimiento = ""){
                    ...
                    alert("Debe seleccionar EL PROCEDIMIENTO");
                    $("#procePat").focus();
                    
                }
                else if(mediSolicitante=="" ){
            
                    alert("Debe ingresar MEDICO SOLICITANTE");
                    ...
                    alert("Debes ingresar  AUDITOR ASIGNADO");
                    $("#idAuditorAsignado").focus();
                }else if(cantidadProce ==""){
                ...
                else
                {
                     ...
                     if(idRegSec2 =="" ){
                            let resp = await buscarProcedVinculado(procePAt);
                            proceEncontrado = resp;
                            console.log('procedimiendo vincuklado Encontrado',proceEncontrado);
                                if(proceEncontrado != null){

                                  
                                    let response = await generarMovimiento(proceEncontrado,idOrden);
                                        //numMovi =JSON.parse(response);
                                       
                                        NumMovimiento=response.datos.IdMovimiento;
                                        NroOrdenMovimiento=response.datos.IdOrdenMovimiento;
                                        console.log('Número de movimiento generado:', NumMovimiento);
                                        console.log('Número de NumOrdenMovimiento generado:', NroOrdenMovimiento);
                                        info.NumMovimiento=NumMovimiento;
                                        info.NroOrdenMovimiento = NroOrdenMovimiento;
                                                ...
                                                if(NumMovimiento){
                                                    $.NotificationService.showInfoNotification({
                                                        title: "Mensaje",
                                                        message: "Se creó número Movimiento " + NumMovimiento + " correctamente"
                                                    });                              
                                                    // setTimeout(function() {
                                                    //     var url = "http://192.168.36.121:8084/hnal/registroPatologia.php";
                                    ...
                                    console.log("no Se encontrò  Datoos para Procedimiento")
                                    alert("No Se encontrò  Datoos para Procedimiento")
                                }    
                               
                        }
                   
                        if (listaProducto.length > 0) {
                            console.log('numero productos', listaProducto);
                            for (const obj of listaProducto) {
                                console.log('objeto', obj.IdProducto);
                        
                                try {
                                    const data = await new Promise((resolve, reject) => {
                                        obtenerProcexProducto(obj.IdProducto, function(error, data) {
                                            if (error) {
                                                console.error('Se produjo un error:', error);
                                                reject(error);
                                            } else {
                                    ...
                                    if (data) {
                                        console.log('ID procedimiento:', data.idProcedimiento);
                                        console.log('ID TiEStudio:', data.idTipoEstudio);
                                        console.log('ID SubProced', data.idSubProced);
                        
                                        let data1 = await buscarCorrelPatfParticular(data.idTipoEstudio, data.idProcedimiento, data.idSubProced);
                        
                                        console.log('dataaa', data1);
                                        $("#corPat").val(data1[0]);
                                        $("#nroOrdenPat").val(data1[1]);
                                        $("#formatoPatologiaMac").val(data1[1]);
                        
                                        info.tipoEstPat = data.idTipoEstudio;
                                        info.nroOrdenPat = data1[1];
                                        info.corPat = data1[0];
                                        info.procePat = data.idProcedimiento;
                                        info.subProcePat = data.idSubProced;
                        
                                        console.log('ordenPAt', info.nroOrdenPat);
                                        console.log('corPat', info.corPat);
                                        ...
                                        await $.ajax({
                                            ...
                                            success: function(resp) {
                                                ...
                                                setTimeout(function() {
                                                    // var url = "http://192.168.36.121:8084/hnal/registroPatologia.php";
                                                    var url = "http://seguros.hloayza.local/registroPatologia.php";
                                                    $(location).attr('href', url);
                                                }, 2000);
                                            ...
                                            error: function(xhr, status, error) {
                                                ...
                                                $.NotificationService.showErrorNotification({
                                                    title: "Error",
                                                    message: "Ocurrió un error al guardar los cambios. Por favor, inténtelo de nuevo."
                                                });
                                            }
                                        });
                                    } else {
                           ...
                           $.ajax({
                                ...
                                success: function(resp){               
                                        ...
                                        //  url = "http://192.168.36.121:8084/hnal/registroPatologia.php";
                                        // $(location).attr('href',url);
            ...
            async function generaFUA_PDF() {
                var Cuenta = $("#ctinmuno").val(); 
                var numMovimiento = $("#nroMovimiento").val(); // Número de movimiento
            ...
            //     //alert($("#ctinmuno").val());
            //     window.location='Controlador/ejecutarFua.php?IdCuentaAtencion='+$("#ctinmuno").val();
            // }
            function generaFUA(){
                window.location='Controlador/ejecutarFua.php?IdCuentaAtencion='+$("#ctinmuno").val();
            ...
            ///yaa
           async function buscarUsuarioVinculado(id){

                try {
                    let response = await $.ajax({
                        dataType:'json',
                        url: "./Controlador/search.php?function=buscarUsuarioVinculado",
                        method: 'POST', // o POST según sea necesario
                        data: {
                            id: id
                        },
            ...
            async function buscarServicioSIGH(IdservicioPat){


                try {
                    let response = await $.ajax({
                        url: "./Controlador/search.php?function=buscarServicioSIGH",
                        dataType: 'html',
                        method: 'GET', 
                        data: {
                            idServico: IdservicioPat
                        },
                    });
                    return response; // Este será el valor retornado cuando se complete el AJAX
                } catch (error) {
            ...
            async function registroPacienteCervicoVaginalId()
            {
           ...
           async function registroPacientePatologia4()
            {
                    ...
                    $.ajax({
                        ...
                        success: function(resp){               
                               ...
                               // alert("Guardado correctamente");
                                ...
                                // Obtenemos la URL base del proyecto
                                // var baseUrl = window.location.origin + window.location.pathname;
                                // // Redirigimos al archivo relativo dentro del proyecto
                                // var redirectUrl = baseUrl.replace(/\/[^\/]*$/, '') + "/registroPatologia.php";
           ...
           async function registroPacientePatologia55()
            {
        ...
        async function editarProcedimientos() {
            if(contador==0){
                $("#GuardarPaciente").addClass('readOnly'); 
            ...
            let resp = await buscarProcedVinculado(procePAt);
            proceEncontrado = resp;
            var MedicoAuditor = $('#idAuditorAsignado option:selected').data('codcompatible');
            console.log('cuenta', ctinmuno);  
            console.log('Movimiento', numMovimiento);  
            console.log('ordenMovimiento', nroOrdenMovimiento);  
            console.log('cantidad', cantidadProce);  
            console.log('procedimiento nuevo', proceEncontrado);  
            console.log('cantidad', cantidadProce);  
            ...
            if (contador > 1) {
                ...
                try {
                    let response = await $.ajax({
                        ...
                        data: {
                            ...
                            NroOrdenMovimiento: nroOrdenMovimiento,
                            CantidadProce: cantidadProce,
                            ProceEncontrado: proceEncontrado,
                            MedicoAuditor:MedicoAuditor //Agregado
                        },
                    });
                ...
                console.log('Primera llamada, no se ejecuta AJAX.');
            }
        }
                           ...
                           /* if(idAuditorAsignado ==""){
                                ...
                                $.ajax({
                                    ...
                                    success: function(resp){
                                            ...
                                            reg = "http://seguros.hloayza.local/registroPatologia.php";
                                            // reg = "http://192.168.36.121:8084/hnal/registroPatologia.php";
      ...
      function RegistrarPacienteEmCETecnico()
            {
                ...
                function buscarDniEm(){
                            ...
                            //  url: "http://192.168.36.121:8084/apidni.php?dni="+ doc,    
                             dataType: "json", 
                             success: function (data) { 
                ...
                function llenarTabla(datos) {
                    const tbody = $('#tbl_mostrarProcedxOrden tbody');
                    tbody.empty(); // Limpiar el contenido existente
                
                    console.log('datos tabla', datos); // Verifica la estructura del objeto
                
                    // Recorrer los datos y agregar filas a la tabla
                    $.each(datos, function(index, item) {
                        tbody.append(`
                            <tr>
                                <td style="padding: 5px;">${item.CodigoProd}</td>
                                <td>${item.NombreProd || 'Nombre no disponible'}</td> // Proporcionar un valor por defecto
                                 <td style="padding: 50px;">${item.Cantidad}</td>
                             </tr>
                        `);
                    });
                }
                ...
                function buscarDniEmCE(){
                             ...
                             type: "POST",  
                             url: "http://seguros.hloayza.local/apidni.php?dni="+ doc,    
                            // url: "http://192.168.36.121:8084/hnal/apidni.php?dni="+ doc,    
                             dataType: "json", 
                             success: function (data) { 
                ...
                function buscarDniEmCERef(doc,campo){
                             ...
                             type: "POST",  
                             url: "http://seguros.hloayza.local/apidni.php?dni="+ doc,    
                            //  url: "http://192.168.36.121/hnal/apidni.php?dni="+ doc,    
                             dataType: "json", 
                             success: function (data) { 
                ...
                function buscarCorrelPatf(tipoEstudio,tipoproced){
                    /*if(cambiarNumAP == true){
                        //no cambia AP


                    }*/
                    if(cambiarNumAP == false){
                        var nroOrdenPat = $("#nroOrdenPat").val();
                ...
                // async function buscarCorrelPatfParticular(tipoEstudio, tipoproced) {
                //     var nroOrdenPat = $("#nroOrdenPat").val();
                ...
                //         return response; // Devuelve los datos recibidos
                //     } catch (error) {
                ...
                async function buscarCorrelPatfParticular(tipoEstudio, tipoproced,SubtipoProc) {
                var nroOrdenPat = $("#nroOrdenPat").val();
            
                try {
                    const response = await $.ajax({  
                        type: "POST",  
                        url: "./Controlador/search.php?function=buscarCorrelPatfParticular&tipo=" + tipoEstudio + "&proc=" + tipoproced+ "&SubtipoProc=" + SubtipoProc,
                        dataType: "json"
                    });
                ...
                function buscarProcedFacturado(tipoproced){
                   
                    $.ajax({  
                        type: "GET",  
                        url: "./Controlador/search.php?function=bucarProceFacturado",    
                        dataType: "json", 
                        data: {tipoproced:tipoproced},
                        success: function (data) { 
                           console.log('es tarifado:',data);
                           if (data == "TARIFADO") {
                            $("#codTarifado").val("TARIFADO"); // Mostrar "TARIFADO" en el input
                            $("#codTarifado").css("color", "green"); // Cambiar el color del texto a verde
                        } else {
                            // Si no es "TARIFADO"
                            $("#codTarifado").val("NO TARIFADO"); // Mostrar "NO TARIFADO" en el input
                            $("#codTarifado").css("color", "red"); // Cambiar el color del texto a rojo
                        }
                ...
                function buscarSubProcedFacturado(idDis){
                   
                    $.ajax({  
                        type: "GET",  
                        url: "./Controlador/search.php?function=bucarProceFacturado",    
                        dataType: "json", 
                        data: {tipoproced:idDis},
                        success: function (data) { 
                           console.log('es tarifado:',data);
                           if (data == "TARIFADO") {
                            $("#codTarifado").val("TARIFADO"); // Mostrar "TARIFADO" en el input
               ...
               /*  function buscarDniEm(){
                 ...
                 async function  webServiceSisHnal(ide,tipoDoc){
                    ...
                    if($("#tipoDoc").val()=="2"){
                     ...
                     $.ajax({
                        ...
                        //  url:'http://192.168.36.121:8084/hnal/webservice/webservice.php',
            ...
            function  webServiceSis(ide){
                       ...
                       var tipoDoc = $("#tipoDoc").val();
                        ...
                        $.ajax({
                            ...
                            // url:'http://192.168.36.121:8084/hnal/webservice/index.php',
                            type:'GET',
                            dataType:'json',
                            data:{ id:ide             
                        },                    
                           ...
                           // alert(idSesion); 
                                $.ajax({
                                    ...
                                    // url:'http://192.168.36.121:8084/hnal/webservice/datos.php',
                                    type:'GET',
                                    dataType:'json',
                        ...
                        function  webServiceSis2(ide,tipoDoc){
                               ...
                               var tipoDoc = '';
                                ...
                                $.ajax({
                                    ...
                                    url:'http://seguros.hloayza.local/webservice/webservice.php',
                                    // url:'http://192.168.36.121:8084/webservice/webservice.php',
                                    type:'GET',
                                    dataType:'json',
                                    data:{ id:ide,tipo:tipoDoc},
                    ...
                    function  webServiceCuenta(ide){
                               ...
                               var tipoDoc = '';
                                ...
                                $.ajax({
                                    ...
                                    // url:'http://192.168.36.121:8084/hnal/webservice/wscuenta.php',
                                    type:'GET',
                                    dataType:'json',
                                    data:{ cuenta:ide},
...
function editarObservacionRo(id,ocu,tipo){
 ...
 //   if(procePat > 13 && tipo == 2){
         ...
         $("#categoria").css("cursor","not-allowed"); 
...
function agregarCptsCitoEspec()
{
    ...
    var cptCitoEs = $("#cptCitoEs").val();
    var descrEspecCito = $("#descrEspecCito").val();
    var selecCitoEspec = $("#selecCitoEspec").val();


    if(cptCitoEs =="" && descrEspecCito =="" && selecCitoEspec =="0"){
...
function agregarCptsCitoEspec_InformeCito()
{
  
    var info = $("#frmCptsCitoEs_InformeCito").serialize(); 
    var id = $("#idRegPatot_InformeCito").val();
    

    var cptCitoEs = $("#cptCitoEs_informeCito").val();
    var descrEspecCito = $("#descrEspecCito_informeCito").val();
    var selecCitoEspec = $("#selecCitoEspec").val();
    ...
    if(cptCitoEs =="" && descrEspecCito =="" && selecCitoEspec =="0"){
        ...
        $.ajax({
            type: "POST",
            dataType: 'html',
            url: "./Controlador/controllerProcedimientos.php?function=RegistroCitoEspec_InformeCito",
            data: info,
    
            success: function(resp){               
               
                    $('#frmCptsCitoEs_InformeCito')[0].reset();
                    $('#cerraObsverPax_Informe').click();
                    CargarCptCitologia(id);
...
function abrirCIEO(){
    const pdfUrl = './images/CIEO-3.1._ACCESIBLE.pdf#page=77';
...
function AgregarProced(){
    var confirmacion = confirm("¿Desea Agregar un  Procedimiento?");
     ...
     <div class="form-group row">
         ...
         <div class="col-md-2 col-sm-6 ">
             <select class="form-control col" id="tipoEstPatProced2" name="tipoEstPatProced2"></select>
         ...
         <div class="col-md-2 col-sm-6 ">
             <select class="form-control col" id="procePatProced2" name="procePatProced2"></select>
         </div>
         <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align hidden" style="margin-top: 4px; font-size: 11px; text-align: right;" id="lblsubproProced2">SUB PROC</label>
         <div class="col-md-2 col-sm-6 hidden" id="selesubprocProced2" style=" width: 220px; ">
             <select class="form-control col" id="subProcePatProced2" name="subProcePatProced2">
         ...
         <div id="cod_tarifado" class="hidden">
             <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align" style="margin-top: 4px; font-size: 11px; text-align: right;">COD TARIFADO</label>
             <div class="col-md-2 col-sm-6 ">
                 <input class="form-control" placeholder="codTarifado" id="codTarifadoProced2" name="codTarifadoProced2">
             </div>
         </div>
         <div class="">
             <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align" style="margin-top: 4px; font-size: 11px; text-align: right;">CANT.</label>
             <div class="col-md-1 col-sm-3">
                 <input class="form-control" placeholder="Cantidad" value="1" id="cantidadProcProced2" name="cantidadProcProced2">
             </div>    
         </div>
         <div>
            <button type="button" class="borrarProced2" style="  width: 100; background: white;border: 1px solid white;color: red;font-weight: 800;">X</button>
         </div>
        </div>
    `;
    ...
    if (confirmacion) {
        document.getElementById('contenedorFilas').innerHTML += nuevaFila;
        $("#AgregarProcedimiento").addClass("hidden");
        agregarProcedimientoClicked = true;
    }
    
    cargartipoEstPatProced2(0);
   
}
function mostrarSegundProc(){
    var nuevaFila = `
    <div class="form-group row">
        <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align " style="text-align: right; margin-top: 4px; font-size: 11px; text-align: right;">NRO FACTURA</label>
        <div class="col-md-2 col-sm-6 ">
            <input id="factPat" class="form-control col " type="text" name="factPat" value="">
        </div>
        <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align" style="margin-top: 4px; font-size: 11px; text-align: right;">TIPO DE ESTUDIO</label>
        <div class="col-md-2 col-sm-6 ">
            <select class="form-control col" id="tipoEstPatProced2" name="tipoEstPatProced2" value="">
        ...
        <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align" style="margin-top: 4px; font-size: 11px; text-align: right;">PROCEDIMIENTO</label>
        <div class="col-md-2 col-sm-6 ">
            <select class="form-control col" id="procePatProced2" name="procePatProced2" value="">
                <!-- Aquí también deberías agregar las opciones dinámicamente si es necesario -->
            </select>
        </div>
        <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align hidden" style="margin-top: 4px; font-size: 11px; text-align: right;" id="lblsubproProced2">SUB PROC</label>
        <div class="col-md-2 col-sm-6 hidden" id="selesubprocProced2">
            <select class="form-control col" id="subProcePatProced2" name="subProcePatProced2" value="">
                <option value="">Seleccionar</option>
                <option value="14">BLOQUE CELULAR</option>
                <option value="15">CITOLOGIA LIQUIDOS, LAVADOS Y CEPILLADO</option>
                <option value="16">ON SITE</option>
        ...
        <div id="cod_tarifado" class="hidden">
            <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align" style="margin-top: 4px; font-size: 11px; text-align: right;">COD TARIFADO</label>
            <div class="col-md-2 col-sm-6 ">
                <input class="form-control" placeholder="codTarifado" id="codTarifadoProced2" name="codTarifadoProced2" value=""> <!-- Valor codTarifado -->
            </div>
        </div>
        <div>
            <label for="middle-name" class="col-form-label col-md-1 col-sm-3 label-align" style="margin-top: 4px; font-size: 11px; text-align: right;">CANT.</label>
            <div class="col-md-1 col-sm-3">
                <input class="form-control" placeholder="Cantidad" value="" id="cantidadProcProced2" name="cantidadProcProced2">
            </div>    
        </div>
    </div>
`;
...
//Agregado
$(document).on('click', '.borrarProced2', function() {
    $(this).closest('.form-group').remove();
    $("#AgregarProcedimiento").removeClass("hidden")
    agregarProcedimientoClicked = false;
});
...
function RegistrRotulo()
{
    ...
    console.log('info de form',info)
    var categoria = $("#categoria").val();  
    var SubCatego = $("#rotulo").val(); 
    console.log('suCategoria',SubCatego);
    var procePat = $("#procePat").val();
    var formatoPatologiaMac = $("#formatoPatologiaMac").val();
    var filtroTipoEst = $("#filtroTipoEst").val();
...
function RegistrarExtension()
{
  
    var info = $("#formRotuloExten").serialize();
    var dxExten = $("#dxExten").val();  
    ...
    if(dxExten==""){
            ...
            $.NotificationService.showErrorNotification({
                              title:"Mensaje",
                              message:"Debes llenar en el campo DIAGNOSTICO"
            });
        ...
        $.ajax({
            type: "POST",
            dataType: 'html',
            url: "./Controlador/controllerProcedimientos.php?function=RegistroExtension",
            data: info,
    
            success: function(resp){               
               
                $('#formRotuloExten')[0].reset();
                //$('#cerrRExtot').click();
                var idP = getParameterByName('id');
                CargaExtensionIhHq(idP);
...
function CargaExtensionIhHq($id)
{
    $('#datExrObsIhqHq').load('consultaExtension.php?id='+$id);
...
function CargarCptCitologia($id)
{
    ...
    $('#tableDxMorf_InformeCito').load('consultaCptsCito.php?id='+$id);
...
function EliminaLineasExten(cod)
{
    ...
    if (opcion == true) {
        ...
        $.ajax({
                type: "POST",
                dataType: 'html',
                url: "./Controlador/controllerProcedimientos.php?function=eliminarExte",
                data: "cod="+cod,
                success: function(resp){
...
function modificarNumAP()
{
  
    actualizarAP=true;
    let click = true; 
       
    $("#nroOrdenPat").removeAttr('readonly', 'readonly');
    
    var nuevoNumAPNuevo = $("#nroOrdenPat").val();  
    var cortPatNuevo = nuevoNumAPNuevo.split('-')[1];
    

    $('#corPat').val(cortPatNuevo);
    
    console.log('corPat', $('#corPat').val()); 
    console.log('nuevoNumAP', nuevoNumAPNuevo);  
...
function cargarListSistemaReporte(id,hallazgo) {
    ...
    function(data){
      ...
      if (data != "[]") {
            ...
            $.each(item, function (i, valor) {
                console.log('valorr hallazgov',valor);
                if (valor.Id == id) {
...
function cargartipoEstPatProced2(pa) {
    ...
    function(data){
      ...
      if (data != "[]") {
            var item = $.parseJSON(data);
            console.log('data proced2',item)
             $("#tipoEstPatProced2").empty();
            $("#tipoEstPatProced2").append('<option value="">Seleccionar</option>');
            $.each(item, function (i, valor) {
                if (pa == valor.idTi) {
                      $("#tipoEstPatProced2").append('<option value="' + valor.idTi + '" selected>' + valor.nombre + '</option>');	
                  }else{
                      $("#tipoEstPatProced2").append('<option value="' + valor.idTi + '">' + valor.nombre + '</option>');	
                  }
            });
        }
    return false;
...
function cargarUsersAuditorAsignado(pa) {
    ...
    function(data){
      ...
      if (data != "[]") {
            ...
            // });
            $.each(item, function (i, valor) {
                var option = '<option value="' + valor.id + '" data-codcompatible="' + valor.codCompatible + '">' + valor.nom + '</option>';
                if (pa == valor.id) {
                    option = '<option value="' + valor.id + '" data-codcompatible="' + valor.codCompatible + '" selected>' + valor.nom + '</option>';
                }
                $("#idAuditorAsignado").append(option);
            });
        }
    return false;
    });
    ...
    $.post('./Controlador/search.php?function=procePat&tipo='+ pa, 
        function(data){
          ...
          if (data != "[]") {
                ...
                $.each(item, function (i, valor) {
                    console.log('tttt', valor);
                    
                    // Definir clase según el valor de CodTarifario
                    var optionClass = valor.CodTarifario == "TARIFADO" ? 'tarifado' : 'no-tarifado';
                    
                    // Agregar valor extra en data-tarifario
                    if (id == valor.idtpo) {
                        // Opción seleccionada con el atributo data-tarifario
                        $("#procePat").append('<option value="' + valor.idtpo + '" class="' + optionClass + '" data-IdSubTipo="' + valor.IdSubTipo + '" selected>' + valor.NombreCorto + '</option>');  
                    } else {
                        // Otras opciones con el atributo data-tarifario
                        $("#procePat").append('<option value="' + valor.idtpo + '" class="' + optionClass + '" data-IdSubTipo="' + valor.IdSubTipo + '">' + valor.NombreCorto + '</option>');  
                    }
                });
            }
        return false;
...
//agreagado
function cargarprocePatProced2(pa,id) {
    ...
    $.post('./Controlador/search.php?function=procePat&tipo='+ pa, 
        function(data){
          ...
          if (data != "[]") {
                var item = $.parseJSON(data);
                $("#procePatProced2").empty();
                $("#procePatProced2").append('<option value="">Seleccionar</option>');
                $.each(item, function (i, valor) {
                    console.log('datos 2', valor);
                    ...
                    if (id == valor.idtpo) {
                        // Opción seleccionada con el atributo data-tarifario
                        $("#procePatProced2").append('<option value="' + valor.idtpo + '" class="' + optionClass + '" data-IdSubTipo="' + valor.IdSubTipo + '" selected>' + valor.NombreCorto + '</option>');  
                    } else {
                        // Otras opciones con el atributo data-tarifario
                        $("#procePatProced2").append('<option value="' + valor.idtpo + '" class="' + optionClass + '" data-IdSubTipo="' + valor.IdSubTipo + '">' + valor.NombreCorto + '</option>');  
                    }
                });
            }
        return false;
...
function cargarSubprocePat(idDis,id) {
    
    $.post('./Controlador/search.php?function=subProcePat&tipo='+ idDis, 
    function(data){
    
      if (data != "[]") {
            var item = $.parseJSON(data);
            $("#subProcePat").empty();
            $("#subProcePat").append('<option value="">Seleccionar</option>');
            $.each(item, function (i, valor) {
                console.log('tttt',valor);
                var optionClass = valor.CodTarifario == "TARIFADO" ? 'tarifado' : 'no-tarifado'; // Verifica si es tarifado
    
                if (id == valor.idtpo) {
                    // Opción seleccionada
                    $("#subProcePat").append('<option value="' + valor.idtpo + '" class="' + optionClass + '" selected>' + valor.NombreCorto + '</option>');  
                } else {
                    // Otras opciones
                    $("#subProcePat").append('<option value="' + valor.idtpo + '" class="' + optionClass + '">' + valor.NombreCorto + '</option>');  
                }
            });
        }
    return false;
...
function cargarSubprocePatProced2(idDis,id) {
    
    $.post('./Controlador/search.php?function=subProcePat&tipo='+ idDis, 
    function(data){
        console.log('data subrpo2',data);
    
      if (data != "[]") {
            var item = $.parseJSON(data);
            $("#subProcePatProced2").empty();
            $("#subProcePatProced2").append('<option value="">Seleccionar</option>');
            $.each(item, function (i, valor) {
                console.log('tttt',valor);
                var optionClass = valor.CodTarifario == "TARIFADO" ? 'tarifado' : 'no-tarifado'; 
                ...
                if (id == valor.idtpo) {
                    // Opción seleccionada
                    $("#subProcePatProced2").append('<option value="' + valor.idtpo + '" class="' + optionClass + '" selected>' + valor.NombreCorto + '</option>');  
                } else {
                    // Otras opciones
                    $("#subProcePatProced2").append('<option value="' + valor.idtpo + '" class="' + optionClass + '">' + valor.NombreCorto + '</option>');  
                }
            });
        }
    return false;
...
async function deleteRegistro(idPato, IdNumMovimiento, IdCuentaAtencion) {
...
//Agregado
function eliminarRegistroAP(idPato){
    $.ajax({
        url:'./Controlador/search.php?function=eliminarRegistro',
        type:'GET',
        dataType:'json',
        data:{ idPato:idPato}
...
function validarSisHnal(){
                
    var  tipoDoc = $("#tipoDocPato").val();
    var ide =  $("#nroDocPato").val();
    if(tipoDoc =="" && ide =="" ){
        alert('Ingrese Num DNI');
    }
    console.log('tipoDoc',tipoDoc);
    console.log('nroDoc',ide);
    //webServiceSisPato(dni,idTipo);
    $.ajax({
        ...
        if(datos[0]!="NO SE ENCONTRO AFILIACION PARA EL DNI CONSULTADO"){
            alert("SIS ACTIVO ENCONTRADO");

            $("#iprId").val(datos[8]);
             buscarIpress(datos[7]);
            
        }else{
            alert("SU SIS NO ESTÀ ACTIVO, INGRESE NUM ORDEN/BOLETA");
...
async function validarSisHnalInformeFinal(){
    ...
    $.ajax({
        ...
        if(datos[0]!="NO SE ENCONTRO AFILIACION PARA EL DNI CONSULTADO"){
            ...
            let  res = sisActivoEncontradoReporteFinal();
            console.log(res);

        }else{
            alert("SU SIS NO ESTÀ ACTIVO");
...
async function sisActivoEncontradoReporteFinal(){
    var NumMovimiento =   $("#nroMovimiento").val();
    var IdCuentaAtencion=  $("#ctinmuno").val();
    var Orden  =  $("#nroOrdenMovimiento").val();
    console.log('movimiento:',NumMovimiento);
    console.log('CuentaAtecion:',IdCuentaAtencion);
...
function limpiarMarcadorExtension(){
