                ...
                if(e.which == 13) { 
                    ...
                    console.log(IdCuentaAtencion);
                     if (IdCuentaAtencion !== "") {
                        ...
                        $.ajax({
                            url:'./Controlador/controllerResys.php?function=ObtenerDatosCuenta', 
                            method: 'GET', 
                            data: { 
                                opcionResys: 1,
                            ...
                            success: function(res) {
                                ...
                                if (datos) {
                                    ...
                                    $("#pacientePato").val(datos.PrimerNombre +' '+datos.ApellidoPaterno +' '+datos.ApellidoMaterno);
                                    ...
                                    if(datos.IdTipoServicio ==2){
                                        ...
                                        datos.IdTipoServicioProviene  =2
                ...
                if(e.which == 13) { 
                    ...
                    console.log(nroDocumento,nroSerie);
                     ...
                     if (nroDocumento !== "") {
                        ...
                        $.ajax({
                            url:'./Controlador/controllerResys.php?function=ObtenerDatosCuentaXReceta', 
                            method: 'GET', 
                            data: { 
                                opcionResys: 4,
...
// FIN LOAD WINDOWS SCARTE
            ...
            function buscarProcedVinculado(procePAt,callback) {
                // var procePAt = $('#procePat').val();
                $.ajax({
                    type: "POST",
                    dataType: 'html',
                    ...
                    success: function(resp) {  
                        ...
                        if (!resp) {
                            ...
                            console.warn(" Valor de Procedimiento vacia");
                            return;
                        }
                        try {
            ...
            function buscarMedicoVinculado(callback) {
                var mediSolicitante = $('#mediSolicitante').val();
                    ...
                    console.log('Rne Medico',rneMedico); 
                ...
                $.ajax({
                    ...
                    success: function(resp) {  
                        ...
                        if (!resp) {
                            ...
                            console.warn(" Valor de rne vacia");
                            return;
                        }
                        try {
                            var respuesta = JSON.parse(resp);
            ...
            function buscarDatosMedicoVinculado(nreMedico,callback) {
                // var procePAt = $('#procePat').val();
                var respuesta='';
                $.ajax({
                    type: "POST",
                    dataType: 'html',
                    url: "./Controlador/search.php?function=buscarDatosMedicoVinculado",
                    data: {
                        opcionResys:4,
                        nreMedico: nreMedico
                    },
                    success: function(resp) {  
                        ...
                        if (!resp) {
                            ...
                            console.log(" DATOS MEDICOS ENCONTRADO VACIA",resp);
                            respuesta= "";
                        }else{
                            console.log(" DATOS MEDICOS ENCONTRADOS",resp);
                            try {
            ...
            function  generarMovimiento(procePAt,callback){
                ...
                buscarServicioSIGH(IdservicioPat,function(codServicioSIGH){
                    if(!codServicioSIGH){
                        ...
                        IdservicioEgreso =codServicioSIGH;
                        buscarUsuarioVinculado(user,function(codCompatibleEncontrado) {
                            if(!codCompatibleEncontrado){
                                console.log("codigo USuario Vacio",codCompatibleEncontrado)
                            }
                                console.log("codigoo Usaurio Encontrado",codCompatibleEncontrado)
                             
                                codEmpleado =codCompatibleEncontrado;
        
                                    if(procePAt != null){
                                        $.ajax({
                                            type: "POST",
                                            dataType: 'html',
                                                url: "./Controlador/ejecutar.php?function=CreaMovimientoLaboratorio",
                                            data: {
                                            
                                                ctinmuno:Idcuenta,
                                                idAuditorAsignado: auditoAsignado,
                                            ...
                                            success: function(resp) {  
                                                    ...
                                                    if (respuesta.resultado) {
                                                        var numeroMovimiento = respuesta.datos; 
                                                        $.NotificationService.showInfoNotification({
                                                            title: "Mensaje",
                                                            message: "Se creó número Movimiento " + numeroMovimiento + " correctamente"
                                                        });                              
                                                        setTimeout(function() {
                                                            var url = "http://localhost/hnal/registroPatologia.php";
                                                            $(location).attr('href', url);
                                                        }, 2000);
                                                        if (typeof callback === 'function') {
                                                            callback(numeroMovimiento);
                                                        }
                                    
                                                    } else {
                                                        console.error('Error en la respuesta del servidor:', respuesta.mensaje);
                                                    }
         ...
         function registroPacientePatologia()
            ...
            var info = $("#frmRegistroPacientePato").serialize(); 
               ...
               var numMovi = 0;
                ...
                {
                    buscarProcedVinculado(procePAt,function(resp) {   
                        proceEncontrado = resp;
                         console.log('procedimiendo vincuklado Encontrado',proceEncontrado);
                         if(proceEncontrado != null){
     
                             generarMovimiento(proceEncontrado,function(numeroMovimiento) {
                        
                                 numMovi = numeroMovimiento;
                                 console.log('Número de movimiento generado:', numMovi);
                                ...
                                if(numMovi){
                                    $.ajax({
                                        ...
                                        success: function(resp){               
                                                ...
                                                //  url = "http://localhost/hnal/registroPatologia.php";
                                                // $(location).attr('href',url);
            ...
            $('#nroMovimiento').on('keydown', function(e) {
              alert('rr');
                // if (e.key === 'Enter' || e.keyCode === 13) {
                //     e.preventDefault();
    
                //     var nroMovimiento = $(this).val(); 
                //     console.log('averr',nroMovimiento)
    
                //     if (nroMovimiento.length > 0) {
                //         // Ejecutar la solicitud AJAX
                //         $.ajax({
                //             url: "./Controlador/controllerProcedimientos.php?function=obtenerDatosPorMovimientos",
                //             type: 'POST', // Método de la solicitud
                //             data: {nroMovimiento: nroMovimiento}, // Datos que se envían (el número de movimiento)
                //             dataType: 'json', // Tipo de datos que esperamos recibir
                //             success: function(response) {
                //                 console.log('jee');
                //                 // Si se recibe una respuesta, rellenamos los campos
                //                 if (response) {
            ...
            ///yaa
            function buscarUsuarioVinculado(id,callback){
                ...
                $.ajax({
                    ...
                    success: function(resp) {  
                        ...
                        if (!resp) {
                            ...
                            console.warn(" Codigo comp no Encontrado");
                            return;
                        }
                        try {
                            var respuesta = JSON.parse(resp);
                            console.log('IdEmpleado Encontrado',respuesta);
            ...
            function buscarServicioSIGH(IdservicioPat,callback){

                 console.log('ID servicio enviadooo',IdservicioPat)
                $.ajax({
                    type: "GET",
                    dataType: 'html',
                    ...
                    success: function(resp) {  
                        ...
                        try {
                            var respuesta = JSON.parse(resp);
                            console.log('Servicio Encontrado',respuesta);
        ...
        //    function buscarUsuarioVinculadoSIGH(codCompatible){
        ...
        //         type: "POST",
        //         dataType: 'html',
        //         url: "./Controlador/controllerResys.php?function=buscarUsuarioVinculadoSIGH",
        //         data: {
        //             idEmpleado: codCompatible
        //         },
        //         success: function(resp) {  
        ...
        //     }
            ...
            function registroPacientePatologia2()
            {
               ...
               var numMovi = 0;
                ...
                //     proceEncontrado = resp;
                //      console.log('procedimiendo vincuklado Encontrado',proceEncontrado);
                //      if(proceEncontrado != 0 && proceEncontrado != null){
                      
                //      }else{
                //         alert("Error al Generar Num Movimiento");
                //      }
                //  });
