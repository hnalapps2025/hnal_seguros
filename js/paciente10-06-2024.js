                                                        ...
                                                        if(iduser=="" ){
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                success: function(resp){               
                                                                        ...
                                                                        url = "/anapath/pdfAnatomoPatologico.php?id="+ ip;
                           ...
                           /* if(idAuditorAsignado ==""){
                                ...
                                $.ajax({
                                    ...
                                    success: function(resp){
                                            ...
                                            if(procedReal==3){
                                                url = "/anapath/pdfInmunoHistoquimica.php?id="+ ip;
                                            }else{
                                                url = "/anapath/pdfHistoquimica.php?id="+ ip;
                                            }
    ...
    if(passWordC==""){
        ...
        $.ajax({
            ...
            success: function(resp){               
               ...
               $(location).attr('href','https://sighap.com/anapath');
