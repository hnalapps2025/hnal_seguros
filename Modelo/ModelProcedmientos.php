...
// include_once('hnal/Controlador/controllerResys.php');
// include_once(__DIR__ . '/../controllerResys.php');
include_once($_SERVER['DOCUMENT_ROOT'] . '/config.php');
include (CONTROLLER_PATH."conexion.php");
include (CONTROLLER_PATH."controllerResys.php");
...
class ModelProcedmientos{
                   ...
                   function updateRconsideracion($procedimientos){
                    ...
                    function insertDxPreOpera($procedimientos){
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                        ...
                                        $descripDx = $procedimientos['descripDx'];
                                                ...
                                                $consulta3 = "SELECT `idDxHis` FROM `tbl_dxPreOperatorio` WHERE `idRef`='$idHis' AND `dx`='$descripDx'";
                                                $verIf3 = mysqli_query($conn,$consulta3);
                                                $cnt3 = mysqli_num_rows($verIf3);
                                                ...
                                                if($cnt3 > 0){
                                                    //echo "1";
                                                        ...
                                                        if($descripDx !="undefined" || $descripDx != ""){
                                                            $stmt = $conn->prepare( "INSERT INTO  `tbl_dxPreOperatorio`( `iduser`, `idRef`, `dx`, `tipoDx`) VALUES (?, ?, ? ,?)");
                                                            $stmt->bind_param('iiss', $iduser, $idHis,$descripDx,$tipoDx);
                                                            $stmt->execute();
                                                            echo "INSERTADO";
                                                        }
                    ...
                    function insertDxPostOpera($procedimientos){
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                        ...
                                        $descripDx = $procedimientos['descripDx'];
                                                ...
                                                $consulta3 = "SELECT `idDxHis` FROM `tbl_DxPostOperatorio` WHERE `idRef`='$idHis' AND `dx`='$descripDx'";
                                                $verIf3 = mysqli_query($conn,$consulta3);
                                                $cnt3 = mysqli_num_rows($verIf3);
                                                ...
                                                if($cnt3 > 0){
                                                    //echo "1";
                                                        ...
                                                        if($descripDx !="undefined" || $descripDx != ""){
                                                            $stmt = $conn->prepare( "INSERT INTO  `tbl_DxPostOperatorio`( `iduser`, `idRef`, `dx`, `tipoDx`) VALUES (?, ?, ? ,?)");
                                                            $stmt->bind_param('iiss', $iduser, $idHis,$descripDx,$tipoDx);
                                                            $stmt->execute();
                                                            echo "INSERTADO";
                                                        }
                    ...
                    function insertIntervencionRealizada($procedimientos){
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                        ...
                                        $descripDx = $procedimientos['descripDx'];
                                                ...
                                                $consulta3 = "SELECT `idDxHis` FROM `tbl_intervencionRealizada` WHERE `idRef`='$idHis' AND `des`='$descripDx'";
                                                $verIf3 = mysqli_query($conn,$consulta3);
                                                $cnt3 = mysqli_num_rows($verIf3);
                                                ...
                                                if($cnt3 > 0){
                                                    //echo "1";
                                                        ...
                                                        if($descripDx !="undefined" || $descripDx != ""){
                                                            $stmt = $conn->prepare( "INSERT INTO `tbl_intervencionRealizada`( `iduser`, `idRef`, `des`, `tipo`) VALUES (?, ?, ? ,?)");
                                                            $stmt->bind_param('iiss', $iduser, $idHis,$descripDx,$tipoDx);
                                                            $stmt->execute();
                                                            //echo "INSERTADO";
                                                        }
                     ...
                     function insertCirujanoAsist($procedimientos){
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                        ...
                                        $descripDx = $procedimientos['descripDx'];
                                                ...
                                                $consulta3 = "SELECT `idDxHis` FROM `tbl_cirujanosAsistentes` WHERE `idRef`='$idHis' AND `des`='$descripDx'";
                                                $verIf3 = mysqli_query($conn,$consulta3);
                                                $cnt3 = mysqli_num_rows($verIf3);
                                                ...
                                                if($cnt3 > 0){
                                                    //echo "1";
                                                        ...
                                                        if($descripDx !="undefined" || $descripDx != ""){
                                                            $stmt = $conn->prepare( "INSERT INTO `tbl_cirujanosAsistentes`( `iduser`, `idRef`, `des`, `tipo`) VALUES (?, ?, ? ,?)");
                                                            $stmt->bind_param('iiss', $iduser, $idHis,$descripDx,$tipoDx);
                                                            $stmt->execute();
                                                            //echo "INSERTADO";
                                                        }
            ...
            function updatePasoPaciente($procedimientos){
                    ...
                    function CreaMovimientoLaboratorio($procedimientos){
                    ...
                    if ($conn->connect_errno) {
                        ...
                        exit();
                                ...
                                //  $nroMovimiento = $procedimientos['numMovimiento']; 
                                  $iduser =    $procedimientos['iduser'];
                                  ...
                                  $nroSerie =     $procedimientos['nroSerie'];
                                  $nroDocumento =     $procedimientos['nroDocumento'];
                                  $nroOrdenVincuBoleta =     $procedimientos['nroOrdenVincuBoleta'];

                                  //SIS
                                  $IdcuentaAtencion = $procedimientos['cuentaAtencion'];
                                  $NumMovimiento = $procedimientos['NumMovimiento'];
                                  $NroOrdenMovimiento = $procedimientos['nroOrdenMovimiento'];
                                  $ctaPadreVinculada =     $procedimientos['ctaPadreVinculada'];
                                  $servPadreVincu =     $procedimientos['servPadreVincu'];
                                ...
                                // //   $idRegSec2 =     $procedimientos['idRegSec2'];
                                  ...
                                  $subProcePat =     $procedimientos['subProcePat'];
                                  $cantidadProc =     $procedimientos['cantidadProce'];
                                  $nroOrdenReceta =     $procedimientos['nroOrdenReceta'];
                                  //SegundoProcedimiento
                                  $tipoEstPatProced2 =     $procedimientos['tipoEstPatProced2'];
                                   $procePatProced2 =     $procedimientos['procePatProced2'];
                                   $subProcePatProced2 =     $procedimientos['subProcePatProced2'];
                                   $cantidadProcProced2 =     $procedimientos['cantidadProcProced2'];
                                   $NumeroProced =     $procedimientos['NumeroProced'];
                                
                                //   /////FIN ORDENES/////777

                                //Crear Movimiento
                                // $IdCuentaAtencion =$ctinmuno;
                                // $IdPuntoCarga = 3; //A PAto
                                // $idPersonaTomaLab = $idAuditorAsignado;
                                // $idPersonaRecoge = $idAuditorAsignado;
                                // $OrdenaPrueba = $mediSolicitante;
                                //  // funcion para traer el idProdcuto
                                // $idProductoCPT =3978;
                                // $Fecha = $fechaPat;
                                // $IdUsuario = 1;
                                  //$corPat =     $procedimientos['corPat'];
                                  /// DATOS PACIENTES ORDENES///7777
                                  $anio = date("Y");
                                   //muestras
                                $muestras = $procedimientos['muestras'];
                                     ...
                                     if($idRegPatot==""){
                                        ...
                                        `ipress`, `jurisdiccion`, `cuenta`, `historia`, `servicio`, `salacama`, `celular`,`anio`,`tipoServicoPatl`,`selecConvenio`,`ipressConvenio`,`nroFactura` ,`medicoSolicitante`,
                                        `especialidad`,`fechaRecepcion`,`tipoEstudio` ,`procedimiento` ,`corPat` ,`idAuditorAsignado` ,`subproc`,`NroSerie`,`NroDocumento`,`CtaVinculada`,
                                        `ServicioCuentaVinculada`,`NroOrdenVincuBoleta`,`IdNumMovimiento`,`IdCuentaAtencion`,`NroOrdenMovimiento`,`cantidadProc`,`NumeroProced`,`NroOrdenReceta`
                                        ) 
                                        VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
                                        $stmt->bind_param('iissssisssssssiiisssssiiiiisssssssssis', $iduser,$tipoDocPato, $nroDocPato,$pacientePato,$edadPato,$sexoPat,$financiaPTO,
                                        $iprId,$juriPr,$ctinmuno,$historiaPat,$servicioPat,$salacamaPat,$celularPacientePatologia,$anio,$tipoServicoPatl,$selecConvenio,$ipressConvenio, $factPat,$mediSolicitante,
                                        $especialPat,$fechaPat,$tipoEstPat,$procePat,$corPat, $idAuditorAsignado,$subProcePat,$nroSerie,$nroDocumento, $ctaPadreVinculada,$servPadreVincu,$nroOrdenVincuBoleta,
                                        $NumMovimiento,$IdcuentaAtencion, $NroOrdenMovimiento,$cantidadProc,$NumeroProced,$nroOrdenReceta);
                                       
                                       
                                          if($stmt->execute()){
                                            
    
                                             $idRegPatot = $conn->insert_id;
                                        //     var_dump($idRegPatot);
                                        //    exit();
                                           ...
                                           foreach ($muestras as $muestra) {
                                                if ($muestra !== '.'){
                                                    $stmt = $conn->prepare( "INSERT INTO `tbl_muestraPatologia`(`muestra`, `iduser`,formato,tipoest,idMe) VALUES (?,?,?,?,?) ");                                  
                                                    $stmt->bind_param('sisis', $muestra,$iduser,$nroOrdenPat,$tipoEstPat,$idRegPatot);
                                                    $stmt->execute();
                                            ...
                                            if($NumeroProced > 1){
                                                        ...
                                                        //Segundo Procd
                                                         ...
                                                         $stmt = $conn->prepare( "INSERT INTO `tbl_registroPacientesPatologia_Detalle`
                                                        (`idPato`, `fechaRecepcion`, `cuenta`, `anio`,  
                                                            `nroFactura`, `tipoEstudio`, `procedimiento`, `corPat`, 
                                                            `subproc`, `IdNumMovimiento`, `NroSerie`, `NroDocumento`, `CtaVinculada`, 
                                                            `ServicioCuentaVinculada`, `IdCuentaAtencion`, `NroOrdenVincuBoleta`, 
                                                            `NroOrdenMovimiento`, `cantidadProc`)
                                                         VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                                 
                                                 $stmt->bind_param('issisiiiisssssssss', 
                                                                 $idRegPatot,
                                                                 $fechaPat,
                                                                 $ctinmuno,
                                                                 $anio,
                                                 ...
                                                 if($stmt->execute()){
                                                     echo "Insertado PAcientes Detalle";
                                                 }else{
                                    ...
                                    // var_dump('entroo actualizar');
                                    // var_dump($procedimientos);
                                   
                                    
                                    try {
                                        
                                        $stmt = $conn->prepare("UPDATE `tbl_registroPacientesPatologia` 
                                            SET `tipodoc`= ?, `nrodoc`= ?, `paciente`= ?, `edad`= ?, 
                                                `sexo`= ?, `finaciamiento`= ?, `ipress`= ?, `jurisdiccion`= ?, 
                                                `cuenta`= ?, `historia`= ?, `servicio`= ?, `salacama`= ?, 
                                                `celular`= ?, `tipoServicoPatl`= ?, `selecConvenio`= ?, 
                                                `ipressConvenio`= ?, `nroFactura`= ?, `medicoSolicitante`= ?, 
                                                `especialidad`= ?, `fechaRecepcion`= ?, `tipoEstudio` = ?, 
                                                `procedimiento` = ?, `corPat` = ?, `idAuditorAsignado` = ?, 
                                                `subproc` = ?, `cantidadProc`= ?, `NumeroProced`= ? 
                                            WHERE `idPato` = ?");
                                        
                                        
                                        $stmt->bind_param('issssisssssssiisssssiiiiisii', 
                                            $tipoDocPato, $nroDocPato, $pacientePato, $edadPato, $sexoPat, $financiaPTO, 
                                            $iprId, $juriPr, $ctinmuno, $historiaPat, $servicioPat, $salacamaPat, 
                                            $celularPacientePatologia, $tipoServicoPatl, $selecConvenio, $ipressConvenio, 
                                            $factPat, $mediSolicitante, $especialPat, $fechaPat, $tipoEstPat, $procePat, 
                                            $corPat, $idAuditorAsignado, $subProcePat, $cantidadProc, $NumeroProced,$idRegPatot
                                        );
                                        ...
                                        if ($NumeroProced > 1) {
                                                    ...
                                                    $stmt = $conn->prepare("SELECT * FROM tbl_registroPacientesPatologia_Detalle where idPato  = ?");
                                                    $stmt->bind_param('i', $idRegPatot);
                                                    $stmt->execute();
                                                    $result = $stmt->get_result();
                                                // var_dump($result);
                                                // exit();
                                                    if ($result->num_rows > 0) {
                                                        //  var_dump('existe tabla detalle');
    
                                                        $stmt = $conn->prepare("UPDATE `tbl_registroPacientesPatologia_Detalle` 
                                                                                                    SET `fechaRecepcion` = ?, 
                                                                                                        `cuenta` = ?, 
                                                                                                        `anio` = ?, 
                                                                                                        `nroFactura` = ?, 
                                                                            ...
                                                                            $stmt->bind_param('sisiiiiiissssssi', 
                                                                                $fechaPat, 
                                                                                $ctinmuno, 
                                                                                $anio, 
                                                                                $factPat, 
                                                                            ...
                                                                            if ($stmt->execute()) {
                                                                                echo "Actualización de pacientes detalle realizada con éxito.";
                                                                            } else {
                                                                                throw new Exception('Error al actualizar pacientes detalle: ' . $stmt->error);
                                                                            }
                                                    } else {
                                                        // var_dump('nonexiste tabla detalle');
                                                        $stmt = $conn->prepare("INSERT INTO `tbl_registroPacientesPatologia_Detalle`
                                                                (`idPato`, `fechaRecepcion`, `cuenta`, `anio`, `nroFactura`, `tipoEstudio`, 
                                                                `procedimiento`, `corPat`, `subproc`, `IdNumMovimiento`, `NroSerie`, `NroDocumento`, 
                                                                `CtaVinculada`, `IdCuentaAtencion`, `NroOrdenVincuBoleta`, 
                                                                `NroOrdenMovimiento`, `cantidadProc`) 
                                                                VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                                                
                                                        
                                                            $stmt->bind_param('issisiiiissssssss', 
                                                                $idRegPatot, $fechaPat, $ctinmuno, $anio, $factPat, $tipoEstPatProced2, 
                                                                $procePatProced2, $corPat, $subProcePatProced2, $NumMovimiento, $nroSerie, 
                                                                $nroDocumento, $ctaPadreVinculada, $IdcuentaAtencion, 
                                                                $nroOrdenVincuBoleta, $NroOrdenMovimiento, $cantidadProcProced2
                                                            );
                                                            if ($stmt->execute()) {
                                                                echo "Insertado pacientes detalle exitosamente.";
                                                            } else {
                                                                throw new Exception('Error al insertar pacientes detalle: ' . $stmt->error);
                                                            }
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                          ...
                                          $subProcePat =     $procedimientos['subProcePat'];
                                            ...
                                            `especialidad`= ? ,`fechaRecepcion`= ?,tipoEstudio = ?,procedimiento = ?,corPat = ?,idAuditorAsignado = ?,subproc = ?  
                                            WHERE `idPato` ='$idRegSec2'");
                                            $stmt->bind_param('ssssiiiii', $factPat,$mediSolicitante,$especialPat,$fechaPat,$tipoEstPat,$procePat,$corPat,
                                            $idAuditorAsignado,$subProcePat);
                                            $stmt->execute();
                                            //echo "INSERTADO";
                    ...
                    function obtenerDatosPorMovimientos($nroMovimiento){
                                $db = new Conectar();
                                $conn = $db->conexion();
                            ...
                            if ($conn->connect_errno) {
                                ...
                                $stmt = $conn->prepare("SELECT * FROM datosNroMovimiento WHERE nroMovimiento = ?");
                                $stmt->bind_param('s', $nroMovimiento);
                                $stmt->execute();
                                $result = $stmt->get_result();
                    ...
                    function registroPacientePatologia3($procedimientos)
                    {
                        ...
                        try {
                            // Extraer datos del array de procedimientos
                           // var_dump($procedimientos);
                            $iduserPatol = $procedimientos['iduserPatol'];
                            $idPat = $procedimientos['idPat'];
                            $anaMuestraCito = $procedimientos['anaMuestraCito']; // Tipo esperado: string
                            $procedRealCito = $procedimientos['procedRealCito']; // Tipo esperado: string
                            $medicoSolcit = $procedimientos['medicoSolcit']; // Tipo esperado: string
                            $dxClinicoHi = $procedimientos['dxClinicoHi']; // Tipo esperado: string
                            $interpretacPato = $procedimientos['interpretacPato']; // Tipo esperado: string
                            $comentarioPatol = $procedimientos['comentarioPatol']; // Tipo esperado: string
                            $notaPatol = $procedimientos['notaPatol']; // Tipo esperado: string
                            $idReportPdf = $procedimientos['idReportPdf'];
                            $nomApeConfirApepat = $procedimientos['nomApeConfirApepat']; // Tipo esperado: string
                            $fechaHoraReport = date("Y-m-d H:i:s");
                    
                            // Preparar la consulta SQL
                            $stmt = $conn->prepare(
                                "UPDATE `tbl_registroPacientesPatologia` 
                                SET 
                                    `anaMuestraCito` = ?, 
                                    `procedRealCito` = ?, 
                                    `medicoSolcit` = ?, 
                            ...
                            error_log("Error en registroPacientePatologia3: " . $e->getMessage());
                            echo "Ocurrió un error durante la actualización: " . $e->getMessage();
                        }
                    }

                    function registroPacientePatologia55($procedimientos){
                        ...
                        $conn = $db->conexion();
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                        ...
                                        $idPat2222=    $procedimientos['idPat2222'];
                                        $fechaHoraReport =    date("Y-m-d H:i:s");
                                        
                                            $stmt = $conn->prepare( "UPDATE `tbl_registroPacientesPatologia` SET fechaHoraCerEspe = ?  WHERE `idPato` ='$idPat2222'");
                                            $stmt->bind_param('s', $fechaHoraReport);
                                            $stmt->execute();
                                            //echo "INSERTADO";
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                          ...
                                          $turnOnOff =    0;
                                            ...
                                            $stmt = $conn->prepare( "UPDATE `tbl_registroPacientesPatologia` SET idReportPdf = ?,fechaidReportPdf = ?,turnOnOff= ?  WHERE `idPato` ='$idPat'");
                                            $stmt->bind_param('isi', $iduserPatol,$fechaHoraReport,$turnOnOff);
                                            $stmt->execute();
                                            //echo "INSERTADO";
                    ...
                    function registroPacienteCervicoVaginal($procedimientos){
                            ...
                            if ($conn->connect_errno) {
                                ...
                                // exit();
                                          ...
                                          $exiteNeo_Informe = $procedimientos['existeNeo_InformeCito'];
                                          $EspecCelulasEndoCervicales = $procedimientos['EspecCelulasEndoCervicales'];
                                          ...
                                          `datosResposanble`= ? ,`colegioResp`= ? ,`nomApeConfir`= ? ,`colegConfirma`= ?,`txtAreaConclusiones`= ?,`exiteNeo_Informe`= ?, `EspecCelulasEndoCervicales`= ? WHERE `idPato`  = '$idCervico'");
                                          $stmt->bind_param('siiisisisisisissssssssssssisisissssssis', $fechaUltimaRegla ,$listEmbarazo,
                                          ...
                                          $especifTipoOrg ,$cambioReactivos ,$espeCambioReac ,$patronHormonal ,$especifPatronHor,$datosResposanble ,$colegioResp ,$nomApeConfir,$colegConfirma,$txtAreaConclusiones,$exiteNeo_Informe,$EspecCelulasEndoCervicales);
                                            if ($stmt->execute()) {
                                                echo "INSERTADO prim";
                                            } else {
                                                echo "Error en la ejecución: " . $stmt->error;
                    ...
                    function InsertEx($examen){
			        	...
			        	function RegistroCitoEspec($examen){
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                        ...
                                        $idProcedCito    =	$examen['idProcedCito'];
                                        $cptCitoEs  = $examen['cptCitoEs'];
                                        $descrEspecCito =	$examen['descrEspecCito'];
                                        $selecCitoEspec =	$examen['selecCitoEspec'];
                                      
                                    
                                       
                                            $sql = "INSERT INTO `tbl_cptsCitologia`( `cpt`, `descripcion`, `tipo`,code) 
                                            VALUES('$cptCitoEs','$descrEspecCito','$selecCitoEspec','$idProcedCito')";
                                            $result = $conn->query($sql);	
                    ...
                    function RegistroCitoEspec_InformeCito($examen){
                        ...
                        if ($conn->connect_errno) {
                            ...
                            exit();
                                    ...
                                    $idRegPatot_InformeCito    =	$examen['idRegPatot_InformeCito'];
                                    $cptCitoEs_informeCito  = $examen['cptCitoEs_informeCito'];
                                    $descrEspecCito_informeCito =	$examen['descrEspecCito_informeCito'];
                                    $selecCitoEspec =	$examen['selecCitoEspec'];
                                  
                                
                                   
                                        $sql = "INSERT INTO `tbl_cptsCitologia`( `cpt`, `descripcion`, `tipo`,code) 
                                        VALUES('$cptCitoEs_informeCito','$descrEspecCito_informeCito','$selecCitoEspec','$idRegPatot_InformeCito')";
                                        $result = $conn->query($sql);	
                        }
                                return $result;
                }
			        	...
			        	function InsertUsuarioInterno($examen){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                                            ...
                                            $nomusu = $examen['nomusu'];
                                            $emailusu = $examen['emailusu'];
                                            $estadousu = $examen['estadousu'];
                							$userusu =	$examen['userusu'];
                							$password =	$examen['password'];
                							
                						
                			
                							 $sql = "UPDATE `usuarios`  SET user= '$userusu',estado= '$estadousu',nom= '$nomusu',email= '$emailusu',doc= '$teleusu' WHERE id='$idUSX'";
                							 $result = $conn->query($sql);	
			        	...
			        	function envioCorreoUsuario($correo,$personal,$usuario,$pass,$active){
                            ...
                            $cuerpo ='<div style="background-color:#f4f4f4;padding-top:50px;padding-bottom:50px"><div class="adM">
                                    ...
                                    <thead>
                                        <tr>
                                            <td>
                                                <img src="https://sighap.com/anapath/img/correoBarra2.png" style="width:100%;height:auto" class="CToWUd a6T" data-bit="iit" tabindex="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding:40px 30px 0px 30px;font-size:14px!important;color:#363636;font-family:,sans-serif!important;font-weight:400!important;line-height:1.6!important">
                                                <p><strong><span style="color:#9d5fc2">&nbsp;&nbsp;&nbsp;Hola '.$personal.'<br></span></strong></p>
                                                <p>&nbsp;&nbsp;&nbsp;Se ha creado correctamente su usuario.</p>
                                                <p><strong>&nbsp;&nbsp;&nbsp;Detalle de su cuenta</strong></p>
                                                <p>&nbsp;&nbsp;&nbsp;<strong>USUARIO:</strong>&nbsp;&nbsp;&nbsp;'.$usuario.'</p>
                                                <p>&nbsp;&nbsp;&nbsp;<strong>CONTRASEÑA:</strong>&nbsp;&nbsp;&nbsp;'.$pass.'</p>
                                                <p>&nbsp;&nbsp;&nbsp;<strong>ACTIVACION DE USUARIO: </strong>&nbsp;&nbsp;&nbsp;<a href="https://sighap.com/anapath/activacion.php?code='.$active.'" target="_blank" >CLICK AQUI</span></a></p>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            $headers .= "Bcc: ofseguroshnal@gmail.com;jfmoralesc.1190@gmail.com\r\n"; 
			        	...
			        	function updateContrasena($examen){
			        		...
			        		function createEditCaja($examen){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                							...
                							$idCaja  = $examen['idCaja'];
                							$archix  = $examen['archix'];
                						
                							$sql = "UPDATE `tbl_CajasCE` SET userArchivado='$iduser',`archivado` = '$archix'  WHERE `idCa` = '$idCaja'";
                							//echo $sql;
                							$result = $conn->query($sql);	
			        	    ...
			        	    function insertarObsdeCaja($examen){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                							...
                							$iduser  = $examen['iduser'];
                							$idCaja  = $examen['idCaja'];
                							$obsCaja  = $examen['obsCaja'];
                							$ediCaja  = $examen['ediCaja'];
                							
                						
                						    if($obsCaja!=""){
                						        
                						         if($ediCaja !=""){
                						                 $sql = "UPDATE `tbl_observacionesCajas` SET `detalles`='$obsCaja' WHERE `idObs`='$ediCaja'";
                							             $result = $conn->query($sql);	 
                						         }else{
                						             $sql = "INSERT INTO `tbl_observacionesCajas`( `iduser`, `cuenta`, `detalles`) VALUES('$iduser','$idCaja','$obsCaja')";
                							            $result = $conn->query($sql);	     
                						         }
                            ...
                            function InsertObserPaxRotulo($examen){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                                            ...
                                            $calidadMuesCitoEsp =  $examen['calidadMuesCitoEsp'];
                                            $hallazgo =      $examen['hallazgo'];
                                            $sisReporEspex =      $examen['sisReporEspex'];
                                            $clasisEspec =      $examen['clasisEspec'];
                                            $existeNeo =   $examen['existeNeo'];
                                            ...
                                            if($ideRo!=""){
                                                        ...
                                                        if($tipoDecrp==1){
                                							    ...
                                							    idcateg='$idcateg',plantillaApe='$plantillaApe',formatoPatoMac= '$formatoPatologiaMac',tipoEstudio= '$filtroTipoEst',idDescripMacro='$lblUserDecri'
                                                                ,calidaMuestra='$calidadMuesCitoEsp',hallazgo='$hallazgo',sisReporte='$sisReporEspex',clasificacion='$clasisEspec',existeNeo='$existeNeo'  WHERE idRo='$ideRo'";
                                							    $result = $conn->query($sql);	
                                                        }else if($tipoDecrp==2){
                                							    ...
                                							    idcateg='$idcateg',plantillaMicro='$plantillaApe',formatoPatoMac= '$formatoPatologiaMac',tipoEstudio= '$filtroTipoEst',idDescripMicro='$lblUserDecri'  
                                                                ,calidaMuestra='$calidadMuesCitoEsp',hallazgo='$hallazgo',sisReporte='$sisReporEspex',clasificacion='$clasisEspec',existeNeo='$existeNeo'  WHERE idRo='$ideRo'";
                                							    $result = $conn->query($sql);	
                                                        }
                    							...
                    							tipoEstudio,idRegRot,idDescripMacro,existeNeo) VALUES('$iduser','$agRot','$tacos','$descrRot','$categoria',
                    							'$cortesRot','$rotulo','$idcateg','$plantillaApe','$formatoPatologiaMac','$filtroTipoEst','$idRegRot','$lblUserDecri','$existeNeo')";
			        	...
			        	function InsertRegistroProgCirugias($examen){
			        	    ...
			        	    function modelRegisterReporteOperatorio($examen){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                            				    ...
                            				    $ide = $examen['ide'] ;
                                                $iduser = $examen['iduser'];
                                                $fechAhoraInicio = $examen['fechAhoraInicio'];
                                                $fechaHoraFin = $examen['fechaHoraFin'];
                                                $descrReporOpe = $examen['descrReporOpe'] ;
                                                $compliQirurgica = $examen['compliQirurgica'];
                                                $cirujanoPreo = $examen['cirujanoPreo'];
                                                $anesteReporte = $examen['anesteReporte'];
                                                $instrumentRepo = $examen['instrumentRepo'];
                                                $obserReporOpera = $examen['obserReporOpera'];
                                                 $muestraPato       =   $examen['muestraPato'];
                                           
                                                
                                                $coulta1 = "SELECT `idRe` FROM `tbl_reporteOperatorio` WHERE `idPac`= '$ide' ";
                                                $ver1 = mysqli_query($conn,$coulta1);
                                                $cn1 = mysqli_num_rows($ver1);    
                                            ...
                                            if($cn1 >= 1 ){
                    							    ...
                    							    $sql = "UPDATE `tbl_reporteOperatorio` SET `fechAhoraInicio`='$fechAhoraInicio',`fechaHoraFin`='$fechaHoraFin',
                    							    `descrReporOpe`='$descrReporOpe',`compliQirurgica`='$compliQirurgica',`cirujanoPreo`='$cirujanoPreo',`anesteReporte`='$anesteReporte',`instrumentRepo`='$instrumentRepo',
                    							    `obserReporOpera`='$obserReporOpera',muestraPatologica= '$muestraPato'  WHERE  `idPac` ='$ide'";
                    							    $result = $conn->query($sql);
                							    
                							}else{
                							
                        							$sql = "INSERT INTO `tbl_reporteOperatorio`(`idPac`, `idUser`, `fechAhoraInicio`, `fechaHoraFin`, `descrReporOpe`, `compliQirurgica`, `cirujanoPreo`, 
                        							`anesteReporte`, `instrumentRepo`, `obserReporOpera`,muestraPatologica) VALUES ('$ide','$iduser' ,'$fechAhoraInicio','$fechaHoraFin','$descrReporOpe' ,'$compliQirurgica','$cirujanoPreo','$anesteReporte',
                        							'$instrumentRepo','$obserReporOpera','$muestraPato')";
                        ...
                        function InsertRegistroExtension($examen){
                            ...
                            if ($conn->connect_errno) {
                                ...
                                exit();
                                        ...
                                        $iduserExt    =	$examen['iduserExt'];
                                        $ideExtns     =	$examen['ideExtns'];
                                        $tipoExtse    =	$examen['tipoExtse'];
                                        $dxExten      =	$examen['dxExten'];
                                        $interExten   =	$examen['interExten'];
                                        $comeExtsn    =	$examen['comeExtsn'];
                                        $notaExten    =	$examen['notaExten'];
                                        
                                      
                                        $sql = "INSERT INTO `tbl_extensionihq`( `idreg`,iduser,dx,inter,comentario,nota,tipo) VALUES 
                                        ('$ideExtns','$iduserExt','$dxExten','$interExten','$comeExtsn','$notaExten','$tipoExtse')";
                                        //echo $sql;
                                        $result = $conn->query($sql);
			        	...
			        	function RegistrarReferencias($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
            					          ...
            					          $iduser =  $procedimientos['iduser'];
                                          $ideRef =     $procedimientos['ideRef'];
                                          $tipoDocRef  =    $procedimientos['tipoDocRef'];
                                          $NroDocRef =     $procedimientos['NroDocRef'];
                                          $paxRef =     $procedimientos['paxRef'];
                                          $sexoRef =     $procedimientos['sexoRef'];
                                          $FechaNacRef  =    $procedimientos['FechaNacRef'];
                                          $edadRef  =    $procedimientos['edadRef'];
                                          $iafasRef =     $procedimientos['iafasRef'];
                                          $tipoSegRef  =    $procedimientos['tipoSegRef'];
                                          $afiliaRef =     $procedimientos['afiliaRef'];
                                          $caduciRef =     $procedimientos['caduciRef'];
                                          $domiRef =     $procedimientos['domiRef'];
                                          $depaRef =      $procedimientos['depaRef'];
                                          $provRef =      $procedimientos['provRef'];
                                         $disRef =      $procedimientos['disRef'];
                                         $actrasRef     =     $procedimientos['actrasRef'];
                                         $tipoAccRef  =     $procedimientos['tipoAccRef'];
                                         $lisDocs   =    $procedimientos['lisDocs'];
                                         $ingresoReferido  =     $procedimientos['ingresoReferido'];
                                         $idEstabelRef  =     $procedimientos['idEstabelRef'];
                                         $fechaIngresoRef  =     $procedimientos['fechaIngresoRef'];
                                         $servicioOrigenRef =      $procedimientos['servicioOrigenRef'];
                                         $servDestRef  =     $procedimientos['servDestRef'];
                                         $especialidadRef  =     $procedimientos['especialidadRef'] ;
                                         $motivoRef  =     $procedimientos['motivoRef'];
                                         $condPcte  =     $procedimientos['condPcte'];
                                         $tipoTransRef  =     $procedimientos['tipoTransRef'];
                                         $dispoTransRef  =     $procedimientos['dispoTransRef'];
                                         $tipoDocRefRes  =     $procedimientos['tipoDocRefRes'];
                                         $NroDocRefRes  =     $procedimientos['NroDocRefRes'];
                                         $personalResRef  =     $procedimientos['personalResRef'];
                                         $profesionRefRes  =     $procedimientos['profesionRefRes'];
                                         $colegiaturaRef  =     $procedimientos['colegiaturaRef'];
                                         $tipoDocRefResAcompa  =     $procedimientos['tipoDocRefResAcompa'];
                                         $NroDocRefResAcompa  =     $procedimientos['NroDocRefResAcompa'];
                                         $personalResRefAcompa  =     $procedimientos['personalResRefAcompa'];
                                         $profesionRefResAcompa  =     $procedimientos['profesionRefResAcompa'];
                                         $colegiaturaRefAcompa  =     $procedimientos['colegiaturaRefAcompa'];
                                         $hisRefReg  =     $procedimientos['hisRefReg'];
                                         
                                         $CODEESS  =     $procedimientos['CODEESS'];
                                         $anio  =     $procedimientos['anio'];
                                         $corre  = 0;
                                            ...
                                            if($ideRef==""){
                                                ...
                                                $coulta1 = "SELECT `idRef` FROM `tbl_registroReferencias` WHERE `codipres`='$CODEESS' AND anio='$anio' ";
                                                $ver1 = mysqli_query($conn,$coulta1);
                                                $cn1 = mysqli_num_rows($ver1);
                                                
                                                $corre = $cn1+1;
                                                
                                                $sql = "INSERT INTO `tbl_registroReferencias`(`idUserSolRef`, `tipoDocRef`, `NroDocRef`, `paxRef`, `sexoRef`, `FechaNacRef`, `edadRef`, `iafasRef`, `tipoSegRef`, 
                                                ...
                                                `servicioOrigenRef`, `servDestRef`, `especialidadRef`, `motivoRef`, `condPcte`, `tipoTransRef`, `dispoTransRef`, `tipoDocRefRes`, `NroDocRefRes`,
                                                `personalResRef`, `profesionRefRes`, `colegiaturaRef`, `tipoDocRefResAcompa`, `NroDocRefResAcompa`, `personalResRefAcompa`, `profesionRefResAcompa`,
                                                `colegiaturaRefAcompa`,historia,codipres,anio,cor) VALUES ('$iduser','$tipoDocRef','$NroDocRef','$paxRef','$sexoRef','$FechaNacRef','$edadRef',
                                                '$iafasRef','$tipoSegRef','$afiliaRef','$caduciRef','$domiRef','$depaRef','$provRef','$disRef','$actrasRef','$tipoAccRef','$lisDocs','$ingresoReferido',
                                                '$idEstabelRef','$fechaIngresoRef','$servicioOrigenRef','$servDestRef','$especialidadRef','$motivoRef','$condPcte','$tipoTransRef','$dispoTransRef',
                                                '$tipoDocRefRes','$NroDocRefRes','$personalResRef','$profesionRefRes','$colegiaturaRef','$tipoDocRefResAcompa','$NroDocRefResAcompa',
                                                '$personalResRefAcompa','$profesionRefResAcompa','$colegiaturaRefAcompa','$hisRefReg','$CODEESS','$anio',$corre)";
                                                //echo $sql;
                                                
                                            }else{
                                                $sql = "UPDATE `tbl_registroReferencias` SET `tipoDocRef`='$tipoDocRef',`NroDocRef`='$NroDocRef',`paxRef`='$paxRef',`sexoRef`='$sexoRef',
                                                `FechaNacRef`='$FechaNacRef',`edadRef`='$edadRef',`iafasRef`='$iafasRef',`tipoSegRef`='$tipoSegRef',`afiliaRef`='$afiliaRef',`caduciRef`='$caduciRef',`domiRef`='$domiRef',
                                                `depaRef`='$depaRef',`provRef`='$provRef',`disRef`='$disRef',`actrasRef`='$actrasRef',`tipoAccRef`='$tipoAccRef',`lisDocs`='$lisDocs',`ingresoReferido`='$ingresoReferido',
                                                `idEstabelRef`='$idEstabelRef',`fechaIngresoRef`='$fechaIngresoRef',`servicioOrigenRef`='$servicioOrigenRef',`servDestRef`='$servDestRef]',`especialidadRef`='$especialidadRef',
                                                `motivoRef`='$motivoRef',`condPcte`='$condPcte',`tipoTransRef`='$tipoTransRef',`dispoTransRef`='$dispoTransRef',`tipoDocRefRes`='$tipoDocRefRes',`NroDocRefRes`='$NroDocRefRes',
                                                `personalResRef`='$personalResRef',`profesionRefRes`='$profesionRefRes',`colegiaturaRef`='$colegiaturaRef',`tipoDocRefResAcompa`='$tipoDocRefResAcompa',
                                                `NroDocRefResAcompa`='$NroDocRefResAcompa',`personalResRefAcompa`='$personalResRefAcompa',`profesionRefResAcompa`='$profesionRefResAcompa',`colegiaturaRefAcompa`='$colegiaturaRefAcompa'
                                                ,`historia`='$hisRefReg' WHERE `idRef`= '$ideRef'";
                                            }
			        	...
			        	function RegistrarReferenciasHistoria($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                					          ...
                					          $busNroRefHistoria =  $procedimientos['busNroRefHistoria'];
                                              $esta =  1;
                                        
            					            
                                              $sql = "UPDATE `tbl_registroReferencias` SET `estadoRegistro`='$esta'  WHERE `idRef`= '$busNroRefHistoria'";
            								  $result = $conn->query($sql);	
			        	...
			        	function RegistrarReferenciasHistoriaTemporal($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                					          ...
                					          $busNroRefHistoria =  $procedimientos['busNroRefHistoria'];
                					           $anamnesis =  $procedimientos['anamnesis'];
                					           $presionArterial =  $procedimientos['presionArterial'];
                					           $temperatura =  $procedimientos['temperatura'];
                					           $cardiaca =  $procedimientos['cardiaca'];
                					           $respiratoria =  $procedimientos['respiratoria'];
                					           $saturacion =  $procedimientos['saturacion'];
                					           $oxinoterapia =  $procedimientos['oxinoterapia'];
                					           $litroMin =  $procedimientos['litroMin'];
                					           $examenClinico =  $procedimientos['examenClinico'];
                					           $plan =  $procedimientos['plan'];
                					           $notaObservaciones =  $procedimientos['notaObservaciones'];
                                               $respirador =  $procedimientos['respirador'];
                                        
            					            
                                              $sql = "UPDATE `tbl_registroReferencias` SET `anamnesis`='$anamnesis',`presionArterial`='$presionArterial',`temperatura`='$temperatura',
                                              `cardiaca`='$cardiaca',`respiratoria`='$respiratoria',`saturacion`='$saturacion',`oxinoterapia`='$oxinoterapia',`litroMin`='$litroMin',
                                              `examenClinico`='$examenClinico',`plan`='$plan',`notaObservaciones`='$notaObservaciones',`respirador`='$respirador' WHERE `idRef`= '$busNroRefHistoria'";
            								  $result = $conn->query($sql);	
            								 echo $sql;
			        	...
			        	function RegistrarEvalPerRefPesta($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                                              ...
                                              $sql = "UPDATE `tbl_registroReferencias` SET `especEval1`='$especEval1',`especEval2`='$especEval2',`especEvalDatoRef`='$especEvalDatoRef',`estadoRefDatRef`='$estadoRefDatRef',
                                              `derivarJefeServ`='$derivarJefeServ',`personalMedico`='$personalMedicoList',iduserPerRef='$iduser' WHERE `idRef`= '$ideHistoEvalRef'";
			        	...
			        	function RegistrarEvalJefeServicio($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
            					                 ...
            					                 $ideHistoEvalRef = $procedimientos['ideHistoEvalRef'];
                					             $iduserJefeServ = $procedimientos['iduserJefeServ'];
                					             $obsJefeServ =  $procedimientos['obsJefeServ'];
                                                 $estadoRefJefeServ =   $procedimientos['estadoRefJefeServ'];
                                                 $motivoRecEval2 =  $procedimientos['motivoRecEval2'];
                                                 
            					            
                                              $sql = "UPDATE `tbl_registroReferencias` SET `obsJefeServ`='$obsJefeServ',`estadoRefJefeServ`='$estadoRefJefeServ',
                                              `motivoRecEval2`='$motivoRecEval2',idJefeServicio='$iduserJefeServ' WHERE `idRef`= '$ideHistoEvalRef'";
			        	...
			        	function RegistrarEvalJefeGuardia($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
            					                 ...
            					                 $ideHistoEvalRef = $procedimientos['ideHistoEvalRef'];
                					             $iduserJefeGuardia = $procedimientos['iduserJefeGuardia'];
                					             $obsJefeGuardia =  $procedimientos['obsJefeGuardia'];
                                                 $estadoRefJefeGuardia = $procedimientos['estadoRefJefeGuardia'];
                                                 $motivoRecEval3 = $procedimientos['motivoRecEval3'];
                                                 
            					            
                                              $sql = "UPDATE `tbl_registroReferencias` SET `obsJefeGuardia`='$obsJefeGuardia',`estadoRefJefeGuardia`='$estadoRefJefeGuardia',
                                              `motivoRecEval3`='$motivoRecEval3',iduserJefeGuardia='$iduserJefeGuardia' WHERE `idRef`= '$ideHistoEvalRef'";
			        	...
			        	function RegistrarEvalMedicoAudi($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
            					                 ...
            					                 $ideHistoEvalRef = $procedimientos['ideHistoEvalRef'];
                					             $idMedicoAudi = $procedimientos['idMedicoAudi'];
                					             $atencionPacEval =  $procedimientos['atencionPacEval'];
                					             $acciTranRef =  $procedimientos['acciTranRef'];
                					             
                					             
                					          $chkDocCuenta1 =  $procedimientos['chkDocCuenta1'];
                                              $chkDocCuenta2 =  $procedimientos['chkDocCuenta2'];
                                              $chkDocCuenta3 =  $procedimientos['chkDocCuenta3'];
                                              $chkDocCuenta4 =  $procedimientos['chkDocCuenta4'];
                                              $chkDocCuenta5 =  $procedimientos['chkDocCuenta5'];
                                                 
                                                 
            					            
                                              $sql = "UPDATE `tbl_registroReferencias` SET `atencionPacEval`='$atencionPacEval',`idMedicoAudi`='$idMedicoAudi',accidente= '$acciTranRef'
                                              ,chkDocCuenta1= '$chkDocCuenta1',chkDocCuenta2= '$chkDocCuenta2',chkDocCuenta3= '$chkDocCuenta3',chkDocCuenta4= '$chkDocCuenta4',chkDocCuenta5= '$chkDocCuenta5'
                                              WHERE `idRef`= '$ideHistoEvalRef'";
			        	...
			        	function RegistrarEvalPerRefe($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                					             ...
                					             $idPerRef = $procedimientos['idPerRef'];
                					             $ideHistoEvalRef = $procedimientos['ideHistoEvalRef'];
                                              ...
                                              $sql = "UPDATE `tbl_registroReferencias` SET `paxllegoEstab`='$paxllegoEstab',`fechaLlegada`='$fechaLlegada',`cuentaFeLlegada`='$cuentaFeLlegada',`idPerRef`='$idPerRef' 
                                              WHERE `idRef`= '$ideHistoEvalRef'";
			        	...
			        	function RegistrarEvalPerRefeFinal($procedimientos){
            					...
            					if ($conn->connect_errno) {
            						...
            						exit();
                					             ...
                					             $idPerRefinal = $procedimientos['idPerRefinal'];
                					             $ideHistoEvalRef = $procedimientos['ideHistoEvalRef'];
                                                 $estFinalRef = $procedimientos['estFinalRef'];
                                                 $motivoRecEval4 = $procedimientos['motivoRecEval4'];
                                                 $obsEstFinalRef =  $procedimientos['obsEstFinalRef'];
                                              ...
                                              $sql = "UPDATE `tbl_registroReferencias` SET `estFinalRef`='$estFinalRef',`motivoRecEval4`='$motivoRecEval4',`obsEstFinalRef`='$obsEstFinalRef',
                                              `idPerReFinal`='$idPerRefinal' WHERE `idRef`= '$ideHistoEvalRef'";
                        ...
                        function consultaEXtesnionIhHq($id){
                            ...
                            $conn = $db->conexion();
                                ...
                                if ($conn->connect_errno) {
                                    ...
                                    $sql = "SELECT * FROM tbl_extensionihq WHERE idreg ='$id'";
                                    $result = $conn->query($sql);
                        ...
                        function consultaCptsCitologia($id){
                            ...
                            $conn = $db->conexion();
                                ...
                                if ($conn->connect_errno) {
                                    ...
                                    $sql = "SELECT id,cpt,descripcion,tipo,code FROM `tbl_cptsCitologia` WHERE code='$id' ORDER BY id DESC";
                                    $result = $conn->query($sql);
                    ...
                    function eliminarHnalCpms($deletePr){
                     ...
                     function eliminarRegCirugia($deletePr){
                                        ...
                                        if ($conn->connect_errno) {
                                                ...
                                                $idDx  = $deletePr['id'];
                                                $stmt = $conn->prepare( "DELETE FROM `tbl_programacionCirugias` WHERE `idPro` = ?");
                                                $stmt->bind_param('i', $idDx);
                                                $stmt->execute();	
                     ...
                     function eliminarObsPaxcRegCitoEs($deletePr){
                                    ...
                                    if ($conn->connect_errno) {
                                            ...
                                            $idDx  = $deletePr['id'];
                                            $stmt = $conn->prepare( "DELETE FROM `tbl_cptsCitologia` WHERE `id`= ?");
                                            $stmt->bind_param('i', $idDx);
                                            $stmt->execute();	
                    ...
                    function eliminarExte($deletePr){
                    ...
                    if ($conn->connect_errno) {
                            ...
                            $idDx  = $deletePr['id'];
                            $stmt = $conn->prepare( "DELETE FROM `tbl_extensionihq` WHERE `id`= ?");
                            $stmt->bind_param('i', $idDx);
                            $stmt->execute();	
                     ...
                     function deleteTranasPaxObsCajas($deletePr){
                      ...
                      function libresCajas($deletePr){
                                        ...
                                        if ($conn->connect_errno) {
                                                ...
                                                $idDx  = $deletePr['id'];
                                                $stmt = $conn->prepare( "UPDATE `tbl_grupoArchivo` SET `idCaja`='' WHERE `idCaja`= ?");
                                                $stmt->bind_param('i', $idDx);
                                                $stmt->execute();	
                     ...
                     function eliminarFuasXPaquete($deletePr){
                      ...
                      function eliminarDesignFux($deletePr){
                                        ...
                                        if ($conn->connect_errno) {
                                                ...
                                                $idDx  = $deletePr['id'];
                                                $stmt = $conn->prepare( "DELETE FROM `tbl_designacion` WHERE `id` = ? ");
                                                $stmt->bind_param('i', $idDx);
                                                $stmt->execute();
                                                printf("Error: %s.\n", $stmt->error);
                    ...
                    function updateAuditorMasivo($procedimientos){
                     ...
                     function regMuestraIndividualPato($procedimientos){
                        ...
                        if ($conn->connect_errno) {
                                ...
                                $stmt = $conn->prepare( "INSERT INTO `tbl_muestraPatologia`(`muestra`, `iduser`,formato,tipoest,idMe) VALUES (?,?,?,?,?) ");                                  
                                $stmt->bind_param('sisis', $muestra,$iduser,$nroOrdenPat,$tipoEstPat,$id);
                                $stmt->execute();
                                printf("Error: %s.\n", $stmt->error);
                                echo "Actualizado";        
