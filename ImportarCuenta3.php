...
<script>
    $( document ).ready(function() {
            ...
            /* setTimeout(function (){
             ...
             $("#codPreHosCE").keydown(function(e) {
            if(e.which == 9) {
                         e.preventDefault();
                         cargaDenominacionCE();
                         $("#ubiSerHospCE").focus();   
            ...
            $("#codPreHosCE").keypress(function(e) {
            ...
            $( "#ubiSerHospCE" ).change(function() {
        	    var idDis = $("#ubiSerHospCE").val();	
        		cargarCodpreHospiCE(idDis);
        	});
                                    ...
                                    <div class="x_panel">
                                          ...
                                          <form class="form-horizontal form-label-left" id="frmDatosPacientes">
                                                  ...
                                                  <label class="control-label col-md-2 col-sm-3 col-xs-12">NRO FUA <span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                      ...
                                                      <div class="form-group">
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">FECHA ATENCION<span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                                        ...
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12 hidden">FECHA ALTA  <span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                          ...
                                                          <label class="control-label col-md-2 col-sm-3 col-xs-12 hidden" id="diasCont" style="text-align: left;color: red;font-weight: 900;"></label>
                                                      </div>
                                                       <div class="form-group">
                                                      ...
                                                      <div class="form-group">
                                                                ...
                                                                <div class="col-md-1 col-sm-12 col-xs-12">
                                                                    <input type="text" class="form-control" required="required" name="codPreHosCE" tabindex="6" id="codPreHosCE"  style="width: 55px;"  >
                                                                </div>
                                                                 <label class="control-label col-md-2 col-sm-3 col-xs-12">DENOMINACION</label>
                                                                <div class="col-md-5 col-sm-12 col-xs-12" >
                                                                    <select class="form-control" name="ubiSerHospCE" id="ubiSerHospCE" required="required" tabindex="7" style="text-transform: uppercase;"> 
                                                                    </select>
                                                      ...
                                                      <div class="form-group" >
                                                            ...
                                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                                  <textarea class="form-control" rows="3" id="comment" name="comment" style="border: 1px solid red;" maxlength="200"  tabindex="23"></textarea>
                                        ...
                                        <div class="form-group" >
                                          <div class="col-md-9 col-md-offset-9">
                                            ...
                                            <a  onclick="enviarObservacion2(<?php echo $id; ?>)" id="enviar" class="hidden btn btn-danger"> <i class="fa fa-save"></i> Enviar</a>
                    ...
                    <div class="modal fade bs-example-modal-ModalProc" tabindex="-1" id="myModal" role="dialog"  >
                                <div class="modal-dialog modal-lm">
                                  <div class="modal-content">
                                                   ...
                                                   <tr> 
                                                          ...
                                                          <div class="form-group">
                                                               <label class="control-label col-md-2 col-sm-3 col-xs-12" style="text-align: right;">CANTIDAD</label>
                                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                                            <input type="text" class="form-control"  name="cant" id="cant"  tabindex="32">
                                                                      </div>
                                                          ...
                                                          <div class="form-group">
                                                                  ...
                                                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                                                      <select class="form-control" name="dx" id="dx" required="required" tabindex="33" > 
                                            ...
                                            <div class="modal-footer" id="el"> 
                                                  <button type="button" class="btn btn-danger" id="GuardarPaciente1" onclick="insertProc();" tabindex="34" >Guardar</button>                                      
