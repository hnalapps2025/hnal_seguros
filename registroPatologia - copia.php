...
<script type="text/javascript">
  ...
  $(document).ready(function() {
        ...
        var buscar = getParameterByName('buscar');var tipoEstudio = getParameterByName('tipoEstudio');
        

        var table = $('#pac3').DataTable( {
                          "bProcessing": true,
                          "sAjaxSource": "./Controlador/search.php?function=listRegistroPato&buscar="+ buscar+"&tipoEstudio="+tipoEstudio,
                          "bPaginate":true,
