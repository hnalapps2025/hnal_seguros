...
<table class="table bulk_action" id="tab" border="1">
    <thead>
      <tr class="headings" style="background:#357ab4;color:white;font-size: 10px;">
         ...
         <th class="column-title" style="width:50%;text-transform: uppercase;text-align: center;font-size:12px;" id="tileUbs">LAMINAS</th>
      </tr>
    </thead>
                      ...
                      <?php 
                                ...
                                while($mue2 = $ni2->fetch_assoc()){
                                  ...
                                  $anio = date("Y");
                                    ...
                                    $chekear='<input  '.$mue2["checkHisto"].' type="checkbox" style="margin-top: 0px;margin-left: 8px;float: right;" id="'.$mue2["id"].'" name="'.$mue2["id"].'"  onclick="registrarUserHisto('.$mue2["id"].','.$iduser.',3)" ><br>';
