                                    ...
                                    <div class="x_panel">
                                          ...
                                          <form class="form-horizontal form-label-left" id="frmDatosPacientes">
                                                  ...
                                                  <label class="control-label col-md-2 col-sm-3 col-xs-12">NRO FUA <span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                      ...
                                                      <div class="form-group" >
                                                            ...
                                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                                  <textarea class="form-control" rows="3" id="comment" name="comment" style="border: 1px solid red;" maxlength="200"  tabindex="25"></textarea>
                                        ...
                                        <div class="form-group" >
                                          <div class="col-md-9 col-md-offset-9">
                                            ...
                                            <a  onclick="enviarObservacion(<?php echo $id; ?>)" id="enviar999" class="btn btn-danger" tabindex="26"> <i class="fa fa-save" ></i> Enviar</a>
