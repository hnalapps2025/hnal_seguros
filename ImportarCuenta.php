                                    ...
                                    <div class="x_panel">
                                          ...
                                          <form class="form-horizontal form-label-left" id="frmDatosPacientes">
                                                  ...
                                                  <label class="control-label col-md-2 col-sm-3 col-xs-12">NRO FUA <span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx1" id="dx1" tabindex="13"  style="text-transform: uppercase;">
                                                        </div>
                                                          ...
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip1" id="tip1" required="required" tabindex="14">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx2" id="dx2" tabindex="15"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip2" id="tip2" required="required" tabindex="16">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx3" id="dx3" tabindex="17"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip3" id="tip3" required="required" tabindex="18">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx4" id="dx4" tabindex="19"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip4" id="tip4" required="required" tabindex="20">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx5" id="dx5" tabindex="21"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip5" id="tip5" required="required" tabindex="22">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx6" id="dx6" tabindex="23"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip6" id="tip6" required="required" tabindex="24">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx7" id="dx7" tabindex="25"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip7" id="tip7" required="required" tabindex="26">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx8" id="dx8" tabindex="27"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip8" id="tip8" required="required" tabindex="28">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx9" id="dx9" tabindex="29"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip9" id="tip9" required="required" tabindex="30">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                                          <input type="text" class="form-control" required="required"  name="dx10" id="dx10" tabindex="31"  style="text-transform: uppercase;">
                                                        </div>
                                                          <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 35px;">TIPO</label>
                                                          <div class="col-md-1 col-sm-12 col-xs-12" style="width: 80px;">
                                                                <select class="form-control" name="tip10" id="tip10" required="required" tabindex="32">
                                                                        <option value="D">D</option>
                                                                        <option value="P">P</option>
                                                                </select>
                                                           </div>
                                                      ...
                                                      <div class="form-group" >
                                                            ...
                                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                                  <textarea class="form-control" rows="3" id="comment" name="comment" style="border: 1px solid red;" maxlength="200"  tabindex="33"></textarea>
                                        ...
                                        <div class="form-group" >
                                          <div class="col-md-9 col-md-offset-9">
                                            ...
                                            <a  onclick="enviarObservacionEm(<?php echo $id; ?>)" id="enviar999" class="hidden btn btn-danger"> <i class="fa fa-save"></i> Enviar</a>
                    ...
                    <div class="modal fade bs-example-modal-ModalProc" tabindex="-1" id="myModal" role="dialog"  >
                                <div class="modal-dialog modal-lm">
                                  <div class="modal-content">
                                                   ...
                                                   <tr> 
                                                          ...
                                                          <div class="form-group">
                                                               <label class="control-label col-md-2 col-sm-3 col-xs-12" style="text-align: right;">CANTIDAD</label>
                                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                                            <input type="text" class="form-control"  name="cant" id="cant"  tabindex="42">
                                                                      </div>
                                                          ...
                                                          <div class="form-group">
                                                                  ...
                                                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                                                      <select class="form-control" name="dx" id="dx" required="required" tabindex="43" > 
                                            ...
                                            <div class="modal-footer" id="el"> 
                                                  <button type="button" class="btn btn-danger" id="GuardarPaciente1" onclick="insertProc();" tabindex="44" >Guardar</button>                                      
