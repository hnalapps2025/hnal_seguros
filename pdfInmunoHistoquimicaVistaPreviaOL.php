  ...
  <!--<body class="nav-md"  >-->
    <div class="container body">
      <div class="main_container">
        ...
        <!-- page content -->
        <div class="right_col" role="main" style="width: 35%;border: 1px solid black;padding: 12px;margin-left: 30%;box-shadow: 4px 8px 13px 5px #8b8282;" >
   ...
   word-wrap: break-word;'>".$mue["interpretacPato"]."</pre>";
   ...
   white-space: -pre-wrap;      /* Opera 4-6 */
   white-space: -o-pre-wrap;    /* Opera 7 */
   word-wrap: break-word;font-family: sans-serif; '>".$mue["notaPatol"]."</pre>" ?></td>
