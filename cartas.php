                            ...
                            <div class="x_panel">
                              <div class="x_title">
                               ...
                               <!-- <a class="btn btn-success"  href="imporConsol.php"  style="float: right;"><i class="fa fa-file-excel-o"></i> Importar</a>-->
                                <a class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-smCartas" id="agr2" role="button" aria-expanded="false" 
                                style="float: right;" onclick="LimpiarFormCartas();"><i class="fa fa-edit m-right-xs"></i> Nuevo Registro</a>
                                <!--<a href="importarAutorizaciones" class="btn btn-danger" style="float: right;" ><i class="fa fa-upload"></i> Importar</a>-->
                                  ...
                                  <tbody>
                                      <tr>
                                        ...
                                        <div class="alert alert-success alert-dismissible fade in hidden" role="alert" id="alerify">
                                          ...
                                          <div style="display:none;text-align: center;color: #405467;font-family: century gothic;font-size: 21px;" id="dvloadect">
                                              <img src="images/loading.gif" /><br>Espere un momento por favor ..</div>
                                            <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="datagridConsoCartas"> 
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                      ...
                                                      <div class="form-group" >
                                                          <label class="control-label col-md-2 col-sm-3 col-xs-12" style="color: red;">MOTIVO CIERRE<span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                            <div class="col-md-9 col-sm-12 col-xs-12">
                                                              <input type="text" class="form-control" required="required" style="border: 1px solid red;" name="motivo" id="motivo" tabindex="16" >
                                                            </div>
...
<div class="modal fade bs-example-modal-smCuentas" tabindex="-1" id="myModalCe" role="dialog" >
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">

                                <div class="modal-header" style="background-image: linear-gradient(#43a2ca, #0c76a2);color: white;text-align: center;">
                                    <button type="button" class="close" data-dismiss="modal" style="color: white;opacity: 1;">&times;</button>
                                    <h4 class="modal-title" id="titleCuen" style="text-transform: uppercase;font-weight:800;"></h4>
                                    <p style="margin: 0px; " id="refT"></p>
                                </div>
                          ...
                          <form method="POST" onsubmit="return false" action="return false" enctype="multipart/form-data" id="formCuentas" class="formulario form-horizontal form-label-left input_mask">
                                <div class="modal-body">
                                                     <input type="hidden" name="iduser" value="<?php echo $iduser ?>" id="iduser">
                                                     <input type="hidden" name="ideC" id="ideC">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                      ...
                                                      <br>
                                                        ...
                                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                                          <div class="input-group" style="margin-bottom:0px;">
                                                            <input type="text" class="form-control" value="" name="nrocuenta" id="nrocuenta" maxlength="11" required="required" tabindex="1" >
                                                          </div>
                                                        </div>
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">HISTORIA CLINICA<span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                          <div class="col-md-3 col-sm-12 col-xs-12">
                                                            <div class="input-group" style="width: 100%;">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                                          <div class="input-group" style="margin-bottom:0px;">
                                                            <input type="date" class="form-control" name="feat" id="feat" maxlength="11" required="required" tabindex="3" value="<?php  echo $hoy = date("Y-m-d");?>">
                                                          </div>
                                                        </div>
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">CONSULTORIO<span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                                <input type="text" class="form-control" required="required"  name="productoX" id="productoX"  tabindex="4" style="text-transform: uppercase;">
                                                             </div>
                                                      </div>
                                                      <div class="form-group">
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">ATENDIDO:</label>
                                                        <div class="col-md-1 col-sm-12 col-xs-12">
                                                          <div class="checkbox" style="margin-bottom:0px;">
                                                            <input type="checkbox" class="form-control" name="at" id="at" tabindex="5" style="width: 20px;margin-left: 1px;margin-top: -6px;" >
                                                          </div>
                                                        </div>
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">INTERCONSULTA:</label>
                                                        <div class="col-md-1 col-sm-12 col-xs-12">
                                                          <div class="checkbox" style="margin-bottom:0px;">
                                                            <input type="checkbox" class="form-control myref" name="inter" id="inter" tabindex="6" style="width: 20px;margin-left: 1px;margin-top: -6px;" >
                                                          </div>
                                                        </div>
                                                      </div>
                                                                                               
                                                      <button type="button" class="btn btn-danger" id="GuardaCAS" onclick="RegistrarCuentas();" style="float: right;margin-bottom: 4%;" tabindex="6">
                                                      <i class="fa fa-save"></i> Agregar</button>                                      
                                                      <button type="button" class="btn btn-default hidden" data-dismiss="modal" id="cerrarcssX">CERRAR</button>
                                                      <div class="form-group"><br><br><br>
                                                                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="datagridCuentas"> 
