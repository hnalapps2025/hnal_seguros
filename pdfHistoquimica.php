                              ...
                              <div class="col-md-offset-1 col-md-9 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="x_panel">
                                          ...
                                          <table class="tg" style="width: 100%;">
                                                ...
                                                <tr>
                                                <td style="font-size: 12px;font-weight: bolder;text-align: right;">t.Estudio :</td>
                                                  <td style="font-size: 12px;"><?php echo $mue["tipoEstudioDescripcion"]; ?></td>
                                                  <td style="font-size: 12px;font-weight: bolder;text-align: right;">Proced. :</td>
                                                  <td style="font-size: 12px;"><?php echo $mue["procedimientoDescripcion"]; ?></td>
                                                </tr>
...
<br>
   ...
   word-wrap: break-word;  '>".$mue["interpretacPato"]."<br>".$mue["INP"]."<pre>"; ?></td>
                                              ...
                                              <table class="table jambo_table bulk_action"  id="pac" style="border: 1px solid rgba(12, 12, 12, 0.78);width: 100%;" >
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr class="even pointer">
                                                                      ...
                                                                      <td class=" " style="text-transform: uppercase;text-align: left;color: black;font-size: 11px;font-weight: 200;border-bottom: 1pt solid #a29e9e;"><?php 
                                                                      echo "<pre>".$mue["notaPatol"]."<br>".$mue["NOA"]."</pre>" ?></td>
