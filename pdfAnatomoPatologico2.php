...
<br>
                                                    ...
                                                    <tbody>
                                                        <?php while($mue4 = $ni4->fetch_assoc()){ ?>
                                                            ...
                                                            <tr class="even pointer">
                                                                      ...
                                                                      <td class=" " style="text-transform: uppercase;text-align: left;color: black;
                                                                        font-size: 11px;border-bottom: 1pt solid #a29e9e;">
                                                                        CALIDAD DE MUESTRA: 

                                                                        <?php 
                                                                        
                                                                        if($mue4["calidaMuestra"]==1){
                                                                              echo "Insatisfactorio";
                                                                        }else  if($mue4["calidaMuestra"]==2){
                                                                          echo "Limitado";
                                                                         }
                                                                         else  if($mue4["calidaMuestra"]==3){
                                                                          echo "Satisfactorio";
                                                                         }else{
                                                                          echo "";
                                                                         }
   ...
   white-space: -pre-wrap;      /* Opera 4-6 */
   white-space: -o-pre-wrap;    /* Opera 7 */
   word-wrap: break-word;  '>DESCRIPCION: ".$mue4["descMicro"]."</pre>"; ?></td>
                                                       ...
                                                       <?php if($mue4["RE"]!=""){ ?>
                                                            <tr class="even pointer">
                                                                      ...
                                                                      <td class=" " style="text-transform: uppercase;text-align: left;color: black;
                                                                        font-size: 11px;border-bottom: 1pt solid #a29e9e;">
                                                                        SISTEMA REPORTE: <?php echo $mue4["RE"] ?><br>
                                                                        TEJIDO/ORGANO: <?php echo $mue4["TE"]  ?><br>
                                                                        CLASIFICACION: <?php echo $mue4["CLA"] ?>
                                                                      </td>
