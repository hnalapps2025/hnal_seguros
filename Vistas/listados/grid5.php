                                                        ...
                                                        <?php  
                                                              ...
                                                              while($mue = $ni->fetch_assoc()){  
                                                                ...
                                                                ?>
                                                                      ...
                                                                      <td class=" " style="text-transform: uppercase;font-size: 12px;text-align:center;color: black;font-size: 10px;vertical-align: inherit;"><?php echo $mue["cantidad"]; ?></td>
                                                                      <td class=" " style="text-transform: uppercase;font-size: 12px;text-align:right;color: black;font-size: 10px;vertical-align: inherit;"><?php echo "S/.".$mue["valorizacion"]; ?></td>
                                                                      <td class=" " style="text-transform: uppercase;font-size: 12px;text-align:right;color: black;font-size: 10px;vertical-align: inherit;"><?php echo "S/.".$mue["total"]; ?></td>
                                                                      <td class=" " style="text-transform: uppercase;font-size: 12px;text-align:center;color: black;font-size: 10px;vertical-align: inherit;"><?php echo $mue["user"]; ?></td>
