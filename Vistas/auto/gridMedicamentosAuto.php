...
$idpres = $ni->fetch_assoc();
$ni = $pac->consultaXmedicamentosAuto($idpres["id_prestacion"]);
...
?>  
                                              ...
                                              <table class="table jambo_table bulk_action"  id="pac" style="border: 1px solid rgba(12, 12, 12, 0.78);" border="1">
                                                    ...
                                                    <tr class="headings" style="font-size: 13px;background: #d6d8d8;color: black;">
                                                              ...
                                                              <th class="column-title" style="width: 1%;text-align: center;"><a onclick="clearFrmMedxAuto('<?php echo $idpres['id_prestacion'] ?>');" 
                                                              ...
                                                              while($mue = $ni->fetch_assoc()){    
                                                                ...
                                                                ?>
                                                                      ...
                                                                      <td style="text-align: center;" > 
                                                                        <a onclick="verMedicaAuto(<?php echo $mue['idMed']; ?>);" data-toggle="modal" data-target=".bs-example-modal-ModalMed" class="btEdit btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                                                        <a onclick="EliminarMedtAuto(<?php echo $mue['idMed']; ?>);" class="btEdit btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
                                                                      </td>                 
                                                                      <td></td>
                                                            </tr>
                                                        <?php }   ?>
