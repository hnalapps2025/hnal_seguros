...
// 
                                            ...
                                            $sqlNum = "SELECT `idCar` FROM `cartagarantiaprueba` WHERE `NroCarta2`='$roTsanio' AND NroCarta3='$enTer'";
                                            ...
                                            if($fil==0){
                                                    ...
                                                    $query = "INSERT INTO `cartagarantiaprueba`( `nrodoc`, `NroCarta`, `NroCarta2`, `NroCarta3`,
                         ...
                         if($i==1){
                            ...
                            $Reader->ChangeSheet($i);
                                    ...
                                    foreach ($Reader as $Row)
                                    {
                                            ...
                                            $query = "INSERT INTO `cuentas_prueba`( `idprestacion`, `nrocuenta`, `historia`, `fatencion`,
