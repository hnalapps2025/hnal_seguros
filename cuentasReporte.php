  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
                  ...
                  <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                              <div class="x_title">
                                <h2 style="text-transform: uppercase;">Cuentas registradas <small></small></h2>
                              ...
                              <table border="0" class="" >
                                  <tbody>
                                      <tr>
                                          ...
                                          <td><label style="margin-left: 65px;">AÑO: </label></td>
                                          <td><p id="selectTriggerFilter3" style="margin: 0 0 -2px;"></p></td>
                                          <td><label style="margin-left: 65px;">MES: </label></td>
                                          <td><p id="selectTriggerFilter2" style="margin: 0 0 -2px;"></p></td>
                                          <td><label style="margin-left: 65px;">ATENDIDO: </label></td>
                                          <td><p id="selectTriggerFilter" style="margin: 0 0 -2px;"></p></td>
                                      </tr>
                                  </tbody>
                              </table><br>
                                        ...
                                        <div class="alert alert-success alert-dismissible fade in hidden" role="alert" id="alerify">
                                            ...
                                            <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="dlistCuentasR"> 
        ...
        <div class="modal fade bs-example-modal-smCartas" tabindex="-1" id="myModal" role="dialog" >
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                      ...
                                                      <br>
                                                        ...
                                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                                          <div class="input-group" style="margin-bottom:0px;">
                                                            <input type="text" class="form-control" value="" name="NroDoc" id="NroDoc" maxlength="11" required="required" tabindex="1" autofocus>
                                                        ...
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">PACIENTE<span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                          <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <div class="input-group" style="width: 100%;">
                                                              <input type="text" class="form-control" name="paciente" id="paciente" maxlength="11" required="required" tabindex="2" >
                                                            </div>
                                                          </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                                          <input type="date" class="form-control" required="required" max="2100-12-31" value="<?php echo date("Y-m-d")?>" name="feinicio" id="feinicio" tabindex="14" >
                                                        </div>
...
<div class="modal fade bs-example-modal-smCuentas" tabindex="-1" id="myModal" role="dialog" >
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                      ...
                                                      <br>
                                                        ...
                                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                                          <div class="input-group" style="margin-bottom:0px;">
                                                            <input type="text" class="form-control" value="" name="nrocuenta" id="nrocuenta" maxlength="11" required="required" tabindex="1" autofocus>
                                                          </div>
                                                        </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                                          <div class="input-group" style="margin-bottom:0px;">
                                                            <input type="date" class="form-control" name="feat" id="feat" maxlength="11" required="required" tabindex="3" autofocus>
                                                          </div>
                                                        </div>
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">CONSULTORIO<span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                      ...
                                                      <div class="form-group">
                                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">ATENDIDO <span class="required" style="color: red;font-weight: bolder;font-size: 15px;">*</span></label>
                                                        <div class="col-md-1 col-sm-12 col-xs-12">
