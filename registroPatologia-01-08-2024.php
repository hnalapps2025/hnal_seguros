...
<script type="text/javascript">
                          ...
                          $(document).ready(function() {
                                ...
                                var table = $('#pac3').DataTable( {
                                                  "bProcessing": true,
                                                  "sAjaxSource": "./Controlador/search.php?function=listRegistroPato",
                                                  "bPaginate":true,
                              ...
                              <table border="0"  >
                                  <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td><input name="serc" id="serc" type="text" class="form-control" placeholder="Nro Orden, Factura, Cuenta, Paciente, Historia,Nro Doc" autocomplete="off"></td>
