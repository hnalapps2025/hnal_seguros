         ...
         */
         ...
         $('#agregarCompetencia').click(function(){
                 ...
                 $.ajax({
                        ...
                        data:{muestra:muestra,iduser:iduser,tipoEstPat:tipoEstPat,nroOrdenPat:nroOrdenPat,id:id}
                    }).done(function(datos){               
                        
                      $('#tbl_tesjidoPat').DataTable().ajax.url("./Controlador/search.php?function=listMuestraIndi&formato="+nroOrdenPat+"&tipoest="+tipoEstPat+"&id="+id).load();    
                      //$('#tbl_tesjidoPat').DataTable().ajax.reload(null,false);
                      $("#tesjidoPat").val("");
         ...
         /*  INICIA DATATABLE */
               ...
               var id = getParameterByName('id');
                                    ...
                                    var table = $('#tbl_tesjidoPat').DataTable({
                                                  ...
                                                  "bProcessing": true,
                                                  "sAjaxSource": "./Controlador/search.php?function=listMuestraIndi&formato="+formato+"&tipoest="+tipoest+"&id="+id,
                                                  "bPaginate":true,
        ...
        <div class="right_col" role="main">
                ...
                <div class="row" style="margin-bottom: 30px;">
                  <div class="col-md-4"  style="margin-left: 101px;">
                      ...
                      <input type="text" id="nro_movimiento" name="nro_movimiento" class="form-control"    placeholder="Ingresa el Nro de Movimiento">
                  </div> 

                  <div class="col-md-4" style=" margin-left: 84px;">
                        <label for="nro_orden">Nro de Orden</label>
                          <div class="contenedor">
                            <input type="text" class="form-control" id="nroSerie"  maxlength="4" placeholder="nºSerie" style="width: 62px;">
                              <input type="text" class="form-control" id="nroDocumento"  maxlength="8" placeholder="nºDoc." style="width: 100px; margin-right: 200px;;">
                          </div>
                ...
                <div class="form-group row">
                <label class="col-form-label col-md-1 col-sm-3 label-align" for="first-name"  style="font-size: 18px; font-weight: bold;">Cuenta<span class="required">*</span>
                </label>
                <div class="col-md-1 col-sm-6 ">
                ...
                <div class="form-group row">
                          <div class="form-group row">
                            <label class="col-form-label col-md-1 col-sm-3 label-align" for="first-name"  style="font-size: 18px; font-weight: bold;">Receta<span class="required">*</span>
                            </label>
                            <div class="col-md-1 col-sm-6 ">
                            <input type="text" id="idReceta" name="idReceta" required="required" class="form-control " style="font-size: 12px;" >
                          </div>
                ...
                <div class="col-md-2 col-sm-6 " style="margin-left:8%">
                 ...
                 <div class="form-group row" style="float: right;">
                     <button type="button" class="btn btn-danger" id="GuardarPaciente" onclick="registroPacientePatologia();" style="margin-left:-52%;" tabindex="13">GUARDAR</button>
                     <button type="button" class="btn btn-success" id="GuardarPaciente" onclick="modInmuno2();"  style="" tabindex="13">Modificar</button>
                     <button type="button" class="btn btn-info" id="IdGenerarFua" onclick="generaFUA();" style="" tabindex="13">FUA</button>
             ...
             <div id="espcialx">
                   ...
                   <!-- start accordion -->
                    ...
                    <br>
                     <h1 style="font-size: 17px;font-weight: 800;">HISTOQUIMICA | INMUNOHISTOQUIMICA </h1><hr style="margin-top: 10px;">
                      <a class="btn btn-success btn-xs" onclick="limpiarMarcadorExtension();" id="marcHis" data-toggle="modal" data-target=".bs-example-modal-modalPaqueteIhqHq"  style="float: right;"> Agregar + </a>
          ...
          <div class="modal fade bs-example-modal-modalPaqueteIhqHq" tabindex="-1" id="myModal" role="dialog" >
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                          ...
                          <form method="POST" onsubmit="return false" action="return false" enctype="multipart/form-data" id="formRotuloExten" class="formulario form-horizontal form-label-left input_mask">
                                <div class="modal-body">
                                          ...
                                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">                                           
                                                      ...
                                                      <div class="form-group" id="descD7677iv">
                                                            <!-- Guardado de descripcion -->
                                                              ...
                                                              <label class="control-label col-md-23col-sm-3 col-xs-12" style="text-align: left;text-transform: uppercase;">Diagnóstico clínico</label>
                                                              <textarea class="form-control" name="dxExten" id="dxExten" rows="2" style="text-transform: uppercase;" tabindex="12"></textarea>
                                                              
                                                            
                                                      </div>
                                                      <div class="form-group " id="NuevoTabl67esFrm">
                                                                                                                              
                                                                    <label class="control-label col-md-12 col-sm-3 col-xs-12" style="text-align: left;text-transform: uppercase;">Interpretación</label>
                                                                    <textarea class="form-control" name="interExten" id="interExten" rows="2" style="text-transform: uppercase;" tabindex="12"></textarea>
                                                                
                                                      </div>
                                                      <div class="form-group " id="NuevoTableiusFrm">
                                                                                                                              
                                                                    <label class="control-label col-md-12 col-sm-3 col-xs-12" style="text-align: left;text-transform: uppercase;">COMENTARIO</label>
                                                                    <textarea class="form-control" name="comeExtsn" id="comeExtsn" rows="2" style="text-transform: uppercase;" tabindex="12"></textarea>
                                                                
                                                      </div>
                                                      <div class="form-group " id="NuevoTuuuuableiusFrm">
                                                                                                                              
                                                                    <label class="control-label col-md-12 col-sm-3 col-xs-12" style="text-align: left;text-transform: uppercase;">NOTA</label>
                                                                    <textarea class="form-control" name="notaExten" id="notaExten" rows="2" style="text-transform: uppercase;" tabindex="12"></textarea>
                                                                
                                                      </div>
                                                       <br>
                                                      <div class="form-group" id="as">
                                                                                                                              
                                                          <div class="table-responsive" id="datExrObsIhqHq" style="float: left;width: 100%;"> </div>     
                                                                
                                                      </div>
                                                      <Hr>
                                                      <!--<button type="button" class="btn btn-success" style="float: right;margin-bottom: 4%;" id="idDatos" ><i class="fa fa-mail-forward"></i> SIGUIENTE</button>-->
                                                      <button type="button" class="btn btn-danger" id="GuardarPaciente" onclick="RegistrarExtension();" style="float: right;margin-bottom: 4%;" tabindex="13">GUARDAR</button>                                      
                                                      <button type="button" class="btn btn-default hidden" data-dismiss="modal" id="cerrRExtot">CERRAR</button>
                                                       </div>
                                                     </div>
                                                 </div>
                                              </div>
