                              ...
                              <div class="col-md-offset-1 col-md-9 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="x_panel">
                                          ...
                                          <center>
                                            ...
                                            <h2 style="text-align: center;float: none;text-transform: uppercase;font-weight: bolder;font-size: 15px;">INFORME ANATOMO PATOLOGICO</h2>
                         ...
                         <div class="x_panel">
                                          ...
                                          <table class="tg">
                                                ...
                                                <tr>
                                                  ...
                                                  <td style="font-size: 11px;text-transform: uppercase;"><?php echo $mue["USRE"]; ?></td>
                                                ...
                                                <tr>
                                                  ...
                                                  <td style="font-size: 11px;text-transform: uppercase;"><?php 
                                                    if($mue["fechaidGeneraInforme"]!=""){
                                                        echo date('d/m/Y H:i:s',strtotime($mue["fechaidGeneraInforme"]));     
                                                    }
